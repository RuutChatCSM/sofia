...
pub use sofia_protocol::error::CodexErrKind;
...
/// Measurements for one successfully decoded image at the point where Sofia prepares it for
...
pub struct CodexCompactionEvent {
    ...
    pub sofia_error_kind: Option<CodexErrKind>,
    pub sofia_error_http_status_code: Option<u16>,
...
pub struct CodexGoalEvent {
    ...
    pub goal_status: sofia_state::ThreadGoalStatus,
