...
pub enum Feature {
    ...
    /// Requires every reader of the Sofia home to support compressed shared histories.
    ...
    Chronicle,
    /// Compress request bodies (zstd) when sending streaming requests to sofia-backend.
    ...
    Worktrees,
    /// Respect host system proxy settings for Sofia-owned network clients.
    RespectSystemProxy,
    /// Enable collab tools.
    Collab,
    ...
    /// Prompt Sofia Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://developers.openai.com/sofia/config-basic#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart Sofia after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Worktrees can now be enabled from /experimental. Restart Sofia after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Sofia is running a thread.",
