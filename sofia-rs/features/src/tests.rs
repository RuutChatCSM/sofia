...
"#,
    ...
    assert_eq!(
        ...
        Some(FeatureToml::Config(crate::GuardianV2ConfigToml {
            ...
            reasoning_effort: Some(sofia_protocol::openai_models::ReasoningEffort::Minimal),
...
#[test]
fn sofia_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::CodexHooks));
    assert_eq!(feature_for_key("sofia_hooks"), Some(Feature::CodexHooks));
}
