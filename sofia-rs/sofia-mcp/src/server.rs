...
use sofia_rmcp_client::StoredOAuthCredentialSnapshot;
...
pub(crate) struct McpServerConnectionIdentity {
    ...
    sofia_apps_cache_identity: Option<(PathBuf, ConnectorRuntimeContextKey)>,
...
impl McpServerConnectionIdentity {
    ...
    pub(crate) fn has_same_connection_config(&self, other: &Self) -> bool {
        ...
        self.auth == other.auth
            ...
            && self.sofia_apps_cache_identity == other.sofia_apps_cache_identity
