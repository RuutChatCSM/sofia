...
/// Selects the MCP extensions Sofia supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. Sofia retains only the
