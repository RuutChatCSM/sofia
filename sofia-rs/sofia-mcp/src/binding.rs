...
impl PreparedMcpCall {
    ...
    /// Returns whether this call is bound to the host-owned Sofia Apps server.
    ...
    /// this call's exact catalog revision and the extensions owned by the Sofia session.
