...
const SETUP_BIN: &str = "sofia-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "sofia-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Sofia binaries that link the
