...
pub(super) fn main() {
    let allowed_text = probe_path("SOFIA_WINDOWS_ALLOWED_TEXT");
    let denied_text = probe_path("SOFIA_WINDOWS_DENIED_TEXT");
    let allowed_module = probe_path("SOFIA_WINDOWS_ALLOWED_MODULE");
    let denied_module = probe_path("SOFIA_WINDOWS_DENIED_MODULE");
