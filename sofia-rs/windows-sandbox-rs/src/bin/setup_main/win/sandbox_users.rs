...
fn write_secrets(
    ...
    let secrets_dir = sandbox_secrets_dir(sofia_home);
...
pub(super) fn prepare_setup_marker(
    ...
    let marker_path = sandbox_dir(sofia_home).join("setup_marker.json");
