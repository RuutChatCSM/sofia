...
pub use sofia_protocol::config_types::WindowsSandboxProxySettingsMode;
...
#[cfg(target_os = "windows")]
pub use wrapper::SOFIA_WINDOWS_SANDBOX_ARG1;
#[cfg(target_os = "windows")]
...
mod windows_impl {
    ...
    pub fn run_windows_sandbox_capture_with_filesystem_overrides(
        ...
        let capability_roots =
            legacy_session_capability_roots(&permissions, &current_dir, &env_map, sofia_home);
