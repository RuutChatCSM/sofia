...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        sofia_home: PathBuf::from(r"C:\Users\sofia"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\sofia\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            sofia_home: PathBuf::from(r"C:\Users\sofia\.sandbox"),
            real_codex_home: PathBuf::from(r"C:\Users\sofia"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.sofia")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        sofia_home: request.sofia_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |sofia_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
