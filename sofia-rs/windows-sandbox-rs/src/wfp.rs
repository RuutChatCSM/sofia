...
const SESSION_NAME: &str = "Sofia Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Sofia Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Sofia Windows sandbox filters";
const SUBLAYER_NAME: &str = "Sofia Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Sofia Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Sofia-owned identities; do not regenerate them unless we
...
/// Installs the persistent Sofia WFP filters for `account`.
///
...
/// Ensures the persistent Sofia WFP provider exists.
...
/// Ensures the persistent Sofia sublayer exists under the Sofia provider.
