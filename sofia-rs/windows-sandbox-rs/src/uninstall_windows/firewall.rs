...
pub(super) fn cleanup_firewall_rules() -> Result<()> {
    ...
    for name in [
        "sofia_sandbox_offline_block_outbound",
        "sofia_sandbox_offline_block_loopback_tcp",
        "sofia_sandbox_offline_block_loopback_udp",
        "sofia_sandbox_offline_allow_loopback_proxy",
    ] {
