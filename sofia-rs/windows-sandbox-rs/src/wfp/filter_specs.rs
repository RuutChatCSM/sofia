...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "sofia_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "sofia_wfp_icmp_connect_v6",
