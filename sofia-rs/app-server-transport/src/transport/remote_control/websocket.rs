...
pub(super) const REMOTE_CONTROL_INSTALLATION_ID_HEADER: &str = "x-sofia-installation-id";
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-sofia-subscribe-cursor";
...
async fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-sofia-server-id", &enrollment.server_id)?;
...
mod tests {
    ...
    pub(super) async fn remote_control_state_runtime(sofia_home: &TempDir) -> Arc<StateRuntime> {
        StateRuntime::init(
