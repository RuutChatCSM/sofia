pub(crate) const OTEL_TARGET_PREFIX: &str = "sofia_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "sofia_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "sofia_otel.trace_safe";
