#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $SOFIA_HOME/skills."""
...
def _codex_home() -> str:
    return os.environ.get("SOFIA_HOME", os.path.expanduser("~/.sofia"))


def _tmp_root() -> str:
    base = os.path.join(tempfile.gettempdir(), "sofia")
    os.makedirs(base, exist_ok=True)
    return base


def _request(url: str) -> bytes:
    return github_request(url, "sofia-skill-install")
