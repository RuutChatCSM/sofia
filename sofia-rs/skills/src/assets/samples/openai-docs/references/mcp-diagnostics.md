...
3. When the current documentation supports it, the local Sofia CLI setup is:

   ```sh
   sofia mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```
