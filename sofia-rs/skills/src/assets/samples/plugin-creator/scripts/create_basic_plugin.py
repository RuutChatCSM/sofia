...
def build_plugin_json(
    ...
    payload: dict[str, Any] = {
        ...
        "interface": {
            ...
            "shortDescription": f"Use {display_name} in Sofia.",
            "longDescription": f"{display_name} adds a local Sofia plugin scaffold.",
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".sofia-plugin" / "plugin.json"
    write_json(
        plugin_json_path,
        build_plugin_json(
