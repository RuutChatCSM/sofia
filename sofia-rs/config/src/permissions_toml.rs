...
use serde::Serialize;
use sofia_network_proxy::InjectedHeaderConfig;
use sofia_network_proxy::MitmHookActionsConfig;
use sofia_network_proxy::MitmHookBodyConfig;
use sofia_network_proxy::MitmHookConfig;
use sofia_network_proxy::MitmHookMatchConfig;
use sofia_network_proxy::NetworkDomainPermission as ProxyNetworkDomainPermission;
