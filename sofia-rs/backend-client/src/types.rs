pub use sofia_backend_openapi_models::models::ConfigBundleResponse;
pub use sofia_backend_openapi_models::models::CreditStatusDetails;
pub use sofia_backend_openapi_models::models::DeliveredConfigToml;
pub use sofia_backend_openapi_models::models::DeliveredManagedLayers;
pub use sofia_backend_openapi_models::models::DeliveredRequirementsToml;
pub use sofia_backend_openapi_models::models::DeliveredTomlFragment;
pub use sofia_backend_openapi_models::models::PaginatedListTaskListItem;
pub use sofia_backend_openapi_models::models::PlanType;
pub use sofia_backend_openapi_models::models::RateLimitReachedKind;
pub use sofia_backend_openapi_models::models::RateLimitStatusDetails;
pub use sofia_backend_openapi_models::models::RateLimitStatusPayload;
pub use sofia_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use sofia_backend_openapi_models::models::SpendControlLimitDetails;
pub use sofia_backend_openapi_models::models::TaskListItem;
...
pub(crate) struct AdditionalRateLimitWithNormalModel {
    #[serde(flatten)]
    pub details: sofia_backend_openapi_models::models::AdditionalRateLimitDetails,
...
/// Authenticated Sofia user settings used by CLI runtime policy.
