...
use sofia_workload_identity::WorkloadIdentityConfig;
use sofia_workload_identity::WorkloadIdentityError;
use sofia_workload_identity::WorkloadIdentityExchange;
use sofia_workload_identity::WorkloadIdentityToken;
use thiserror::Error;
use url::Url;
...
fn classify_auth_environment(
    ...
    match base_url.trim().trim_end_matches('/') {
        ...
        | "https://chat.openai.com/backend-api/sofia" => {
        ...
        | "https://chatgpt-staging.com/backend-api/sofia" => {
