...
impl Hooks {
    ...
    ) -> anyhow::Result<(Self, Receiver<sofia_protocol::protocol::HookCompletedEvent>)> {
    ...
    ) -> Vec<sofia_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<sofia_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_interrupt(&self) -> Vec<sofia_protocol::protocol::HookRunSummary> {
