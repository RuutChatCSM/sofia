...
pub(crate) fn completed_summary(
    ...
    entries: Vec<sofia_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    let HandlerSourcePath::Local(source_path) = &handler.source_path else {
        unreachable!("executor-scoped hooks do not produce public hook summaries");
    };
...
pub(crate) fn hook_source_label(source: sofia_protocol::protocol::HookSource) -> &'static str {
    match source {
        sofia_protocol::protocol::HookSource::System => "system",
        sofia_protocol::protocol::HookSource::User => "user",
        sofia_protocol::protocol::HookSource::Project => "project",
        sofia_protocol::protocol::HookSource::Mdm => "mdm",
        sofia_protocol::protocol::HookSource::SessionFlags => "session_flags",
        sofia_protocol::protocol::HookSource::Plugin => "plugin",
        sofia_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        sofia_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        sofia_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        sofia_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        sofia_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
