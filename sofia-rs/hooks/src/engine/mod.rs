...
pub(crate) struct ConfiguredHandler {
    ...
    pub builtin: bool,
    pub event_name: sofia_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            sofia_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            sofia_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            sofia_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            sofia_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            sofia_protocol::protocol::HookEventName::PostCompact => "post-compact",
            sofia_protocol::protocol::HookEventName::SessionStart => "session-start",
            sofia_protocol::protocol::HookEventName::SessionEnd => "session-end",
            sofia_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            sofia_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            sofia_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            sofia_protocol::protocol::HookEventName::Stop => "stop",
            sofia_protocol::protocol::HookEventName::Interrupt => "interrupt",
        }
    }
