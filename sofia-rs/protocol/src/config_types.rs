...
/// Limit for the text included in `sofia.tool_result` log records.
...
/// Validated plain profile-v2 name used to select `$SOFIA_HOME/<name>.config.toml`.
...
/// Collaboration mode for a Sofia session.
