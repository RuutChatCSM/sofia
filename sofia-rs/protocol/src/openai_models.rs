//! Shared model metadata types exchanged between Sofia services and clients.
//!
...
/// Metadata describing a Sofia-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Sofia backend `/models` endpoint.
