...
use sofia_guardian_context::MAX_PREVIOUS_REVIEWS;
...
use crate::sofia_thread::GuardianAuthorizationVersion;
use crate::sofia_thread::GuardianRootMessage;
    ...
    pub fn user_input_snapshot(
        ...
        match self.mode {
            GuardianContextMode::ThreadOwned => {
                let answers = history
                    .retained_context()
                    .map(sofia_guardian_context::render_verified_answers);
    ...
    pub(crate) fn user_input_for_call(
        ...
        match self.mode {
            GuardianContextMode::ThreadOwned => history
                ...
                .and_then(sofia_guardian_context::render_verified_answer),
