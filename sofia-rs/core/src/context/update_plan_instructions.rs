//! Omits checklist-tool guidance from Sofia-owned prompts, before adding caller text.

/// Call only for Sofia-owned prompt text; custom instructions must remain unchanged.
