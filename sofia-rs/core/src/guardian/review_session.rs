...
use sofia_analytics::GuardianReviewAnalyticsResult;
use sofia_analytics::GuardianReviewSessionAnalyticsParams;
use sofia_analytics::GuardianReviewSessionKind;
use sofia_extension_api::Instructions;
...
use crate::sofia_delegate::run_codex_thread_interactive;
...
use sofia_tools::normalize_output_image_detail;
...
struct GuardianReviewSessionReuseKey {
    ...
    root_authorization_version: Option<crate::sofia_thread::GuardianAuthorizationVersion>,
...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(
        ...
        Self {
            ...
            sofia_linux_sandbox_exe: spawn_config.sofia_linux_sandbox_exe.clone(),
...
async fn run_review_on_session(
    ...
    let submission = review_session.io.submit_turn_input(
        TurnInputRequest::user_input(prompt_items.items)
            .with_thread_settings(sofia_protocol::protocol::ThreadSettingsOverrides {
                                ...
                                && let Some(error) = last_error
                            {
                                return (
                                    GuardianReviewSessionOutcome::SessionFailed {
                                        ...
                                        error_info: error.sofia_error_info,
                                    },
                                    true,
                                    true,
                                );
