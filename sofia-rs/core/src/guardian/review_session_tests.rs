...
async fn run_review_preserves_evidence_during_parent_compaction() {
    ...
    let ((outcome, _), submitted_text) = tokio::join!(review, async {
        ...
        let sofia_protocol::turn_input::TurnInput::UserInput { content, .. } = request.input else {
...
async fn test_review_params() -> GuardianReviewSessionParams {
    ...
    GuardianReviewSessionParams {
        ...
        request: GuardianApprovalRequest::ExecCommand {
            ...
            cwd: cwd.clone().into(),
            guardian_cwd: sofia_utils_path_uri::LegacyAppPathString::from_abs_path(&cwd),
        ...
        reasoning_effort,
        guardian_default_review_model_id: "sofia-auto-review".to_string(),
