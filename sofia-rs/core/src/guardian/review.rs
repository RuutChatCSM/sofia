...
use sofia_analytics::GuardianReviewDecision;
use sofia_analytics::GuardianReviewFailureReason;
use sofia_analytics::GuardianReviewTerminalStatus;
use sofia_analytics::GuardianReviewTrackContext;
use sofia_analytics::GuardianReviewedAction;
...
use sofia_protocol::protocol::GuardianAssessmentDecisionSource;
...
pub(super) async fn run_synchronous_review(
    ...
    review_reason: sofia_protocol::approvals::GuardianReviewReason,
) -> ReviewDecision {
    ...
    let (guardian_model, guardian_reasoning_effort) = if let Some(preset) = review_model {
        let reasoning_effort = preferred_reasoning_effort(
            preset
                ...
                .iter()
                .any(|effort| effort.effort == sofia_protocol::openai_models::ReasoningEffort::Low),
        ...
        let reasoning_effort = preferred_reasoning_effort(
            turn.model_info()
                ...
                .iter()
                .any(|preset| preset.effort == sofia_protocol::openai_models::ReasoningEffort::Low),
