...
use sofia_config::default_project_root_markers;
use sofia_config::merge_toml_values;
use sofia_config::project_root_markers_from_config;
...
impl LoadedAgentsMd {
    ...
    /// compile `sofia-core` as a normal dependency without that configuration.
