...
use sofia_client::RetryOperation;
...
pub(crate) async fn handle_retryable_response_stream_error(
        ...
        && !turn_context.provider.info().is_amazon_bedrock()
    {
        ...
        sofia_client::record_retry!(retry_state.connection_retries, retry_delay, operation);
    ...
    if retry_state.retries < max_retries {
        ...
        sofia_client::record_retry!(retry_count, delay, operation);
