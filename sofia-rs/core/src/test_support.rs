...
use sofia_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth_with_home(auth: CodexAuth, sofia_home: PathBuf) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing_with_home(auth, sofia_home)
}
...
) -> sofia_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(sofia_home, /*config_model_catalog*/ None)
}
