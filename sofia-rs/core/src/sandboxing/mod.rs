...
command transformation live in the sofia-sandboxing crate; this module keeps
...
pub use sofia_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: sofia_exec_server::ExecEnvPolicy,
...
pub struct ExecRequest {
    ...
    pub(crate) exec_server_shell_snapshot: Option<sofia_exec_server::ShellSnapshotRequest>,
...
) -> sofia_protocol::error::Result<ExecToolCallOutput> {
