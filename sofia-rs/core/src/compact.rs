...
use futures::prelude::*;
use sofia_analytics::CodexCompactionEvent;
use sofia_analytics::CompactionImplementation;
use sofia_analytics::CompactionPhase;
use sofia_analytics::CompactionReason;
use sofia_analytics::CompactionStatus;
use sofia_analytics::CompactionStrategy;
use sofia_analytics::CompactionTrigger;
use sofia_analytics::now_unix_seconds;
use sofia_context_fragments::AnnotatedContent;
...
use sofia_protocol::items::ContextCompactionItem;
...
pub use sofia_prompts::SUMMARIZATION_PROMPT;
pub use sofia_prompts::SUMMARY_PREFIX;
...
async fn run_compact_task_inner(
    ...
    let sofia_error = result.as_ref().err();
    if result.is_ok() {
    ...
    pub(crate) async fn track(
        ...
        sess.services
            ...
            .track_compaction(CodexCompactionEvent {
                ...
                status,
                sofia_error_kind: sofia_error.map(Into::into),
                sofia_error_http_status_code: sofia_error
