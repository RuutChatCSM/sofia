...
/// `sofia_feedback::CodexFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// sofia_core::feedback_tags!(model = "gpt-5", cached = true);
/// sofia_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
