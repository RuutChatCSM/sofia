...
use crate::sofia_thread::GuardianRootSnapshot;
use sofia_history::ReconciledRetainedContext;
use sofia_history::RetainedContextEntry;
use sofia_history::RetainedUserMessage;
            ...
            let mut messages = reconciled
                ...
                .filter_map(|(_, entry)| match entry {
                    ...
                    RetainedContextEntry::VerifiedAnswer(answer) => {
                        sofia_guardian_context::render_verified_answer(answer)
