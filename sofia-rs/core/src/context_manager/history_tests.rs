...
use sofia_protocol::models::ConfigurationReasoning;
...
use sofia_protocol::protocol::APPS_INSTRUCTIONS_OPEN_TAG;
...
use sofia_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
...
fn drop_last_n_user_turns_preserves_prefix() {
    ...
    history.record_retained_context(&sofia_history::RetainedContextEvent::VerifiedAnswer {
        answer: sofia_history::VerifiedAnswer {
            turn_id: "checkpoint-turn".to_owned(),
            call_id: "ask-1".to_owned(),
            questions: vec![sofia_history::VerifiedQuestionAnswer {
