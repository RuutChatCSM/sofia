...
use sofia_context_fragments::set_annotated_content;
use sofia_context_fragments::to_annotated_content;
use sofia_extension_api::ConversationHistorySnapshot;
use sofia_guardian_context::SectionHistory;
use sofia_guardian_context::TranscriptHistory;
...
use sofia_history::RetainedInputSource;
...
use sofia_utils_audio::estimate_audio_token_count;
use sofia_utils_cache::BlockingLruCache;
use sofia_utils_cache::sha1_digest;
...
use sofia_utils_output_truncation::approx_tokens_from_byte_count_i64;
use sofia_utils_output_truncation::truncate_function_output_payload;
...
impl ContextManager {
    ...
    pub(crate) fn drop_last_n_user_turns(&mut self, num_turns: u32) {
        ...
        let first_removed_message_id = snapshot[cut_idx]
            .id()
            .map(sofia_protocol::ResponseItemId::as_str);
