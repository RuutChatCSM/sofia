...
use sofia_prompts::render_review_exit_interrupted;
...
use sofia_protocol::review_format::format_review_findings_block;
...
use crate::sofia_delegate::run_codex_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session
            .services
            .session_telemetry
            .counter("sofia.task.review", /*inc*/ 1, &[]);
        ...
        // Start sub-sofia conversation and get the receiver for events.
