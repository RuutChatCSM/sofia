...
use sofia_rollout_trace::CompactionCheckpointTracePayload;
...
async fn run_remote_compact_task_inner(
    ...
    match pre_compact_outcome {
        ...
        PreCompactHookOutcome::Stopped => {
            ...
            attempt
                .track(
                    sess.as_ref(),
                    sofia_analytics::CompactionStatus::Interrupted,
                    Some(&error),
                    analytics_details,
                )
                .await;
    ...
    if result.is_ok() {
        ...
        if let PostCompactHookOutcome::Stopped = post_compact_outcome {
            attempt
                .track(sess.as_ref(), status, sofia_error, analytics_details)
                .await;
    ...
    async fn collect_compaction_output_accepts_additional_output_items() {
        ...
        let stream = response_stream(vec![
            ...
            Ok(ResponseEvent::Completed {
                ...
                usage_metadata: Some(sofia_protocol::ResponseUsageMetadata {
