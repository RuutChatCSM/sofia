...
use sofia_protocol::protocol::EnvironmentConnectionEvent;
...
impl TurnEnvironmentSnapshot {
    pub(crate) fn has_full_access(
        ...
        sofia_protocol::protocol::has_full_access(
            approval_policy,
            thread_profile,
    ...
    #[cfg(test)]
    pub(crate) fn primary_environment(&self) -> Option<Arc<sofia_exec_server::Environment>> {
        self.primary()
