...
async fn accepted_input_applies_thread_settings() {
    ...
    handle(
        ...
        .with_thread_settings(ThreadSettingsOverrides {
            ...
            approvals_reviewer: Some(sofia_config::types::ApprovalsReviewer::AutoReview),
    ...
    assert_eq!(
        ...
        sofia_config::types::ApprovalsReviewer::AutoReview
    );
    assert!(
...
async fn automatic_admission_rechecks_plan_mode_without_committing_sparse_settings() {
    ...
    impl sofia_extension_api::ConfigContributor<crate::config::Config> for ConfigRecorder {
        fn on_config_changed(
            &self,
            _session_store: &sofia_extension_api::ExtensionData,
            _thread_store: &sofia_extension_api::ExtensionData,
