...
use sofia_core_plugins::ResolvedPluginMetricsOperation;
use sofia_core_plugins::TrustedPluginRoots;
...
use sofia_protocol::permissions::RawFileSystemSandboxPolicy;
...
pub struct TurnContext {
    ...
    pub(crate) extension_data: Arc<sofia_extension_api::ExtensionData>,
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let extension_data = Arc::new(sofia_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    async fn new_turn_context_from_configuration(
        ...
        let trusted_plugin_roots = TrustedPluginRoots::from_plugin_load_outcome(
            &plugin_outcome,
            per_turn_config.sofia_home.as_path(),
        );
        ...
        if turn_context.config.model_provider_id == sofia_model_provider_info::OPENAI_PROVIDER_ID {
    ...
    pub(crate) async fn maybe_emit_model_warnings_for_turn(&self, tc: &TurnContext) {
        ...
        if !tc.code_mode_available
            && matches!(
                ...
                sofia_protocol::openai_models::ToolMode::CodeMode
                    | sofia_protocol::openai_models::ToolMode::CodeModeOnly
            )
