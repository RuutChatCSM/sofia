...
use sofia_git_utils::get_git_remote_urls_assume_git_repo;
use sofia_git_utils::get_has_changes_in_repo;
use sofia_git_utils::get_head_commit_hash;
...
const SOFIA_VERSION_KEY: &str = "sofia_version";
...
impl sofia_analytics::TurnAnalyticsMetadata for TurnMetadataState {
