...
use sofia_network_proxy::BlockedRequest;
...
use sofia_network_proxy::NetworkRequestDisconnect;
...
use sofia_sandboxing::record_network_sandbox_violation;
...
pub(crate) async fn begin_network_approval(
    ...
    let execution_proxy = network
        ...
        .map_err(|err| {
            ToolError::Sofia(sofia_protocol::error::CodexErr::Io(io::Error::other(
