...
//!
//! `sofia-rollout-trace` owns the event schema and writer behavior. This module
...
use sofia_rollout_trace::ToolDispatchInvocation;
use sofia_rollout_trace::ToolDispatchPayload;
use sofia_rollout_trace::ToolDispatchRequester;
use sofia_rollout_trace::ToolDispatchResult;
use sofia_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        sofia_turn_id: invocation.turn.sub_id.clone(),
