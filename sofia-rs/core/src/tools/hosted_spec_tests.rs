...
use sofia_protocol::config_types::WebSearchFilters;
use sofia_protocol::config_types::WebSearchUserLocation;
use sofia_protocol::config_types::WebSearchUserLocationType;
use sofia_tools::ResponsesApiWebSearchFilters;
use sofia_tools::ResponsesApiWebSearchUserLocation;
