...
impl ToolCallRuntime {
    ...
    pub(crate) fn handle_tool_call_with_source(
        ...
        if self
            ...
            .config
            .features
            .enabled(sofia_features::Feature::ExecutedToolCallMetadata)
    ...
    fn failure_response(call: ToolCall, err: FunctionCallError) -> ResponseInputItem {
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                call_id: call.call_id,
                name: None,
                output: sofia_protocol::models::FunctionCallOutputPayload {
                    body: sofia_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
        ...
        macro_rules! log_tool_call {
            ($dispatch_duration_ms:expr, $handler_duration_ms:expr, $total_duration_ms:expr) => {
                info!(
                    ...
                    trace_id = %sofia_otel::current_span_trace_id().unwrap_or_default(),
...
mod tests {
    ...
    async fn cancellation_before_dispatch_admission_logs_dispatch_only_timing() -> anyhow::Result<()>
    {
        ...
        let tool_name = sofia_tools::ToolName::plain("test_tool");
        ...
        let timing_events = logs
            .lines()
            .filter(|line| line.contains("event.name=\"sofia.tool_call\""))
            .collect::<Vec<_>>();
        assert_eq!(
            timing_events.len(),
            1,
    ...
    impl sofia_extension_api::ToolLifecycleContributor for BlockingFinishContributor {
        fn on_tool_finish<'a>(
            &'a self,
    ...
    -> anyhow::Result<()> {
        ...
        let mut builder =
            sofia_extension_api::ExtensionRegistryBuilder::<crate::config::Config>::new();
