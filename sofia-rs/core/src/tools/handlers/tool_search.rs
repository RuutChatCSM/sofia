...
use sofia_tools::LoadableToolSpec;
use sofia_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use sofia_tools::TOOL_SEARCH_TOOL_NAME;
use sofia_tools::ToolName;
use sofia_tools::ToolSearchEntry;
use sofia_tools::ToolSearchInfo;
use sofia_tools::ToolSpec;
use sofia_tools::coalesce_loadable_tool_specs;
use std::sync::Arc;
use std::sync::Mutex;
use std::sync::Weak;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the sofia_app namespace.".to_string(),
            tools: Vec::new(),
        };
