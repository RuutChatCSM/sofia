...
use sofia_sandboxing::policy_transforms::materialize_additional_permissions_with_context;
...
pub(crate) fn normalize_and_validate_additional_permissions(
    ...
    context: &sofia_protocol::permissions::FileSystemSandboxPolicyContext<'_>,
...
pub(super) fn file_system_sandbox_policy_context_for_cwd<'a>(
    ...
    cwd: &'a PathUri,
) -> Option<sofia_protocol::permissions::FileSystemSandboxPolicyContext<'a>> {
    ...
    if effective_permissions
        ...
        .is_some_and(|permissions| {
            permissions.entries.iter().any(|entry| {
                (matches!(
                    &entry.path,
                    sofia_protocol::permissions::FileSystemPath::Special {
                        value: sofia_protocol::permissions::FileSystemSpecialPath::Tmpdir,
                    }
                ) && context
                    ...
                    &entry.path,
                    sofia_protocol::permissions::FileSystemPath::Special {
                        value: sofia_protocol::permissions::FileSystemSpecialPath::ProjectRoots { .. },
