...
use sofia_analytics::ArtifactOperation;
use sofia_analytics::ArtifactOperationLifecycle;
use sofia_analytics::build_track_events_context;
use sofia_apply_patch::AppliedPatchDelta;
use sofia_core_plugins::PluginCommandAttribution;
use sofia_core_plugins::recognize_artifact_operation;
use sofia_otel::ARTIFACT_OPERATION_EXPECTED_OUTPUT_COUNT_METRIC;
use sofia_otel::ARTIFACT_OPERATION_STARTED_METRIC;
...
use sofia_protocol::items::CommandExecutionStatus;
...
use sofia_utils_string::truncate_middle_with_token_budget;
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::Sofia(err)) => match err.details() {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = sofia_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::Sofia(CodexErr::Sandbox(SandboxErr::Denied {
