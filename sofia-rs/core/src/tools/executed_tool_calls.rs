...
use sofia_protocol::models::ExecutedToolCall;
use sofia_protocol::models::ExecutedToolCallArguments;
use sofia_protocol::models::ResponseItem;
use sofia_protocol::models::bound_executed_tool_calls_for_prompt_prioritizing_recent;
use sofia_protocol::models::executed_tool_call_metadata_bytes;
...
impl ExecutedToolCallRecorder {
    pub(crate) fn record_tool_call(
        ...
        let name = sofia_tools::code_mode_name_for_tool_name(&call.tool_name);
    ...
    pub(crate) fn record_tool_result_sources(
        ...
        source: &ToolCallSource,
        call_id: &str,
        result_sources: sofia_protocol::models::ToolResultSources,
    ) -> bool {
        let mut state = self
            .state
            .lock()
