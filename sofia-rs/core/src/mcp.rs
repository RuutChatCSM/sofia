...
use sofia_connectors::PluginConnectorSource;
...
use sofia_extension_api::SelectedPluginIdentity;
use sofia_extension_api::SelectedPluginSnapshot;
use sofia_features::Feature;
use sofia_login::CodexAuth;
use sofia_mcp::EffectiveMcpServer;
use sofia_mcp::McpConfig;
use sofia_mcp::McpEnvironmentAuthority;
use sofia_mcp::McpPluginAttribution;
use sofia_mcp::McpServerRegistration;
use sofia_mcp::McpToolCatalogCache;
use sofia_mcp::SOFIA_APPS_MCP_SERVER_NAME;
use sofia_mcp::ToolInfo;
use sofia_mcp::configured_mcp_servers;
use sofia_mcp::effective_mcp_servers;
use sofia_mcp::sofia_apps_mcp_server_config;
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            sofia_extension_api::empty_extension_registry(),
    ...
    pub fn sofia_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.sofia_apps_tools_cache.clone()
    }
