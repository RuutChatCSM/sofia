...
use futures::Future;
use sofia_memories_read::citations::parse_memory_citation;
use sofia_memories_read::citations::thread_ids_from_memory_citation;
use sofia_protocol::error::CodexErr;
use sofia_protocol::error::Result;
use sofia_protocol::memory_citation::MemoryCitation;
...
use sofia_utils_stream_parser::strip_proposed_plan_blocks;
use tracing::debug;
...
fn strip_hidden_assistant_markup_and_parse_memory_citation(
    ...
    String,
    Option<sofia_protocol::memory_citation::MemoryCitation>,
) {
        ...
        && role == "assistant"
    {
        let combined = content
            ...
            .filter_map(|ci| match ci {
                sofia_protocol::models::ContentItem::OutputText { text } => Some(text.as_str()),
                _ => None,
            })
            .collect::<String>();
...
pub(crate) async fn finalize_turn_item(
    ...
    if let TurnItem::AgentMessage(agent_message) = &mut *turn_item {
        ...
        agent_message.content =
            vec![sofia_protocol::items::AgentMessageContent::Text { text: stripped }];
