...
use sofia_protocol::openai_models::CollaborationModeMessages;
use sofia_protocol::openai_models::ModelMessages;
use sofia_protocol::openai_models::ModelsResponse;
use sofia_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
...
fn model_with_collaboration_messages(
    ...
    default: Option<&str>,
    plan: Option<&str>,
) -> sofia_protocol::openai_models::ModelInfo {
            ...
            .with_thread_settings(ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(sofia_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            }),
...
async fn cold_resume_refreshes_legacy_collaboration_snapshot_once(
    ...
    let legacy_rollout = std::fs::read_to_string(&rollout_path)?
        .lines()
        .map(|original_line| {
            let mut line = sofia_rollout::parse_rollout_line(original_line)?;
