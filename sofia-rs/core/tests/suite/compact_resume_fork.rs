...
//! request payload that Sofia would send to the model and assert that the
...
async fn start_test_conversation(
    ...
    (test.home, test.config, test.thread_manager, test.sofia)
}
...
async fn resume_conversation(
    ...
    let auth_manager = sofia_core::test_support::auth_manager_from_auth(
