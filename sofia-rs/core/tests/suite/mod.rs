...
// It allows the test binary to behave like sofia and dispatch to apply_patch and sofia-linux-sandbox
// based on the arg0.
// NOTE: this doesn't work on ARM
#[ctor]
pub static SOFIA_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("sofia-core-tests", |exe_name, argv1| {
        if argv1 == Some(SOFIA_CORE_APPLY_PATCH_ARG1) {
