...
const SOFIA_APPS_META_KEY: &str = "_codex_apps";
const SOFIA_APPS_MCP_PATH_REGEX: &str = "^/api/sofia/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/sofia/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "sofia-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__sofia_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__sofia_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__sofia_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__sofia_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__sofia_apps__calendar";
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let sofia_apps_meta = body.pointer("/params/_meta/_codex_apps").cloned();
