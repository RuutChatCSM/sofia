...
use sofia_protocol::shell_environment::OPENAI_WORKLOAD_IDENTITY_CONTEXT_ENV_VAR;
...
pub(crate) struct PendingRouteAwareHttpBodyStream {
    ...
    pub(crate) response: sofia_http_client::HttpResponse,
}
...
impl RouteAwareHttpRequestRunner {
    ...
    ) -> Result<(HttpRequestResponse, Option<PendingRouteAwareHttpBodyStream>), JSONRPCErrorError>
    {
        ...
        let request_span = tracing::info_span!(
            "sofia.exec_server.http_request",
            otel.kind = "client",
        ...
        sofia_otel::inject_span_w3c_trace_headers(&request_span, &mut headers);
