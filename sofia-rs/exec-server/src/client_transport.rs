...
const ENVIRONMENT_CLIENT_NAME: &str = "sofia-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(name = "sofia.exec_server.remote.noise.connect", skip_all)]
    ...
    #[tracing::instrument(
        name = "sofia.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "sofia.exec_server.remote.harness.connect",
        )
    )]
    ...
    #[tracing::instrument(
        name = "sofia.exec_server.remote.noise.websocket_connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "sofia.exec_server.remote.noise.websocket_connect",
    ...
    #[tracing::instrument(
        name = "sofia.exec_server.remote.noise.handshake",
        skip_all,
        parent = initialize_span,
        fields(
            otel.kind = "client",
            otel.name = "sofia.exec_server.remote.noise.handshake",
        )
    )]
