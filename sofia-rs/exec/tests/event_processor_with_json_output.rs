...
use serde_json::json;
use sofia_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use sofia_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use sofia_app_server_protocol::CollabAgentTool;
use sofia_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use sofia_app_server_protocol::CommandAction;
use sofia_app_server_protocol::CommandExecutionSource;
use sofia_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use sofia_app_server_protocol::ErrorNotification;
use sofia_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use sofia_app_server_protocol::ItemCompletedNotification;
use sofia_app_server_protocol::ItemStartedNotification;
use sofia_app_server_protocol::McpToolCallError;
use sofia_app_server_protocol::McpToolCallResult;
use sofia_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use sofia_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use sofia_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use sofia_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use sofia_app_server_protocol::WebSearchItem as ApiWebSearchItem;
...
use sofia_exec::AgentMessageItem;
use sofia_exec::CodexStatus;
use sofia_exec::CollabAgentState;
use sofia_exec::CollabAgentStatus;
use sofia_exec::CollabTool;
use sofia_exec::CollabToolCallItem;
use sofia_exec::CollabToolCallStatus;
use sofia_exec::CollectedThreadEvents;
use sofia_exec::CommandExecutionItem;
use sofia_exec::CommandExecutionStatus;
use sofia_exec::ErrorItem;
use sofia_exec::EventProcessorWithJsonOutput;
use sofia_exec::ExecThreadItem;
use sofia_exec::FileChangeItem;
use sofia_exec::FileUpdateChange as ExecFileUpdateChange;
use sofia_exec::ItemCompletedEvent;
use sofia_exec::ItemStartedEvent;
use sofia_exec::ItemUpdatedEvent;
use sofia_exec::McpToolCallItem;
use sofia_exec::McpToolCallItemError;
use sofia_exec::McpToolCallItemResult;
use sofia_exec::McpToolCallStatus;
use sofia_exec::PatchApplyStatus;
use sofia_exec::PatchChangeKind;
use sofia_exec::ReasoningItem;
use sofia_exec::ThreadErrorEvent;
use sofia_exec::ThreadEvent;
use sofia_exec::ThreadItemDetails;
use sofia_exec::ThreadStartedEvent;
use sofia_exec::TodoItem;
use sofia_exec::TodoListItem;
use sofia_exec::TurnCompletedEvent;
use sofia_exec::TurnFailedEvent;
use sofia_exec::TurnStartedEvent;
use sofia_exec::Usage;
use sofia_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        thread_source: None,
        thread_name: None,
        model: "sofia-mini-latest".to_string(),
        model_provider_id: "test-provider".to_string(),
        service_tier: None,
        approval_policy: AskForApproval::Never,
        approvals_reviewer: sofia_protocol::config_types::ApprovalsReviewer::User,
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            sofia_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        sofia_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: sofia_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
