...
use sofia_protocol::protocol::MisalignmentErrorDetails;
...
struct ResponseCompletedUsage {
    ...
    total_tokens: i64,
    #[serde(default)]
    sofia_rollout_budget_units: Option<serde_json::Number>,
}
...
impl From<ResponseCompletedUsage> for TokenUsage {
    fn from(val: ResponseCompletedUsage) -> Self {
        ...
        TokenUsage {
            ...
            sofia_rollout_budget_units: val.sofia_rollout_budget_units,
        }
    }
}
...
mod tests {
    ...
    fn parses_cache_write_token_usage() {
        let usage: ResponseCompletedUsage = serde_json::from_value(json!({
            ...
            "total_tokens": 110,
            "sofia_rollout_budget_units": 2.5
        }))
        ...
        assert_eq!(
            ...
            TokenUsage {
                ...
                total_tokens: 110,
                sofia_rollout_budget_units: serde_json::Number::from_f64(2.5),
            }
        );
    }
            ...
            Err(ApiError::MisalignmentPolicyViolation {
                ...
                assert_eq!(
                    ...
                    &Some(MisalignmentErrorDetails {
                        ...
                        steer: Some(sofia_protocol::protocol::MisalignmentSteer {
    ...
    const CYBER_RESTRICTED_MODEL_FOR_TESTS: &str = "gpt-5.3-sofia";
}
