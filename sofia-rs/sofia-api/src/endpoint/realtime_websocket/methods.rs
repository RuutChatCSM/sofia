...
use http::StatusCode;
use sofia_client::backoff;
use sofia_http_client::maybe_build_rustls_client_config_with_custom_ca;
use sofia_protocol::protocol::ConversationTextParams;
use sofia_protocol::protocol::ConversationTextRole;
use sofia_protocol::protocol::RealtimeTranscriptDelta;
...
const REALTIME_WIRE_LOG_TARGET: &str = "sofia_api::realtime_websocket::wire";
...
impl RealtimeWebsocketClient {
    ...
    async fn connect_realtime_websocket_url(
        ...
        // Realtime websocket TLS should honor the same custom-CA env vars as the rest of Sofia's
...
mod tests {
    ...
    use sofia_protocol::protocol::RealtimeInputAudioSpeechStarted;
    use sofia_protocol::protocol::RealtimeNoopRequested;
    use sofia_protocol::protocol::RealtimeResponseCancelled;
    use sofia_protocol::protocol::RealtimeResponseCreated;
    use sofia_protocol::protocol::RealtimeResponseDone;
    use sofia_protocol::protocol::RealtimeTranscriptDelta;
    use sofia_protocol::protocol::RealtimeTranscriptDone;
    ...
    fn webrtc_frameless_sideband_ignores_provider_base_url() {
        let client = RealtimeWebsocketClient::new(Provider {
            ...
            base_url: "https://chatgpt.com/backend-api/sofia".to_string(),
            query_params: None,
