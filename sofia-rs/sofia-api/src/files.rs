...
const OPENAI_FILE_USE_CASE: &str = "sofia";
...
pub async fn upload_openai_file(
    ...
    let create_request = match hosted_upload {
        Some(context) => serde_json::json!({
            ...
            "file_size": file_size_bytes,
            "use_case": OPENAI_FILE_USE_CASE,
            "sofia_connector_id": context.connector_id,
            "sofia_action_name": context.action_name,
            "sofia_model": context.model,
        }),
        None => create_request,
    };
    ...
    let upload_response = client_pool
        ...
        .map_err(|source| {
            ...
            tracing::event!(
                ...
                tracing::Level::WARN,
                event.name = "sofia.openai_file_blob_upload_failed",
...
mod tests {
    ...
    async fn upload_hosted_app_context_and_finalizes_reservation() {
        ...
        let create_request = serde_json::json!({
            ...
            "file_size": 8,
            "use_case": "sofia",
            "sofia_connector_id": "library",
            "sofia_action_name": "create_library_file",
            "sofia_model": "gpt-work",
        });
        Mock::given(method("POST"))
            .and(path("/backend-api/files"))
            .and(header("chatgpt-account-id", "account_id"))
