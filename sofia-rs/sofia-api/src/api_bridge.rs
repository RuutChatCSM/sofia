...
use sofia_protocol::auth::PlanType;
use sofia_protocol::error::CodexErr;
use sofia_protocol::error::CodexErrorDetails;
use sofia_protocol::error::ConnectionFailedError;
use sofia_protocol::error::RetryLimitReachedError;
use sofia_protocol::error::UnexpectedResponseError;
use sofia_protocol::error::UsageLimitReachedError;
...
const ACTIVE_LIMIT_HEADER: &str = "x-sofia-active-limit";
