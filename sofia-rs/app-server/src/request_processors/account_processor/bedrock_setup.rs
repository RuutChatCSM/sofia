...
use sofia_app_server_protocol::AwsCredentialType;
use sofia_app_server_protocol::BedrockAwsProfile;
use sofia_app_server_protocol::BedrockDiscoverParams;
use sofia_app_server_protocol::BedrockDiscoverResponse;
use sofia_app_server_protocol::BedrockEnvironmentCredential;
...
impl AccountRequestProcessor {
    pub(crate) async fn bedrock_discover(
        ...
        let profiles = sofia_aws_auth::discover_aws_profiles()
            .await
    ...
    pub(crate) async fn bedrock_setup(
        ...
        let profile = match &params {
            BedrockSetupParams::Profile { profile, .. } => {
                ...
                sofia_aws_auth::validate_aws_profile(profile, region)
                    .await
                    .map_err(|err| {
