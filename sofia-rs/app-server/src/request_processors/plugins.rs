...
use sofia_analytics::PluginInstallSource;
use sofia_app_server_protocol::PluginAvailability;
use sofia_app_server_protocol::PluginSharePrincipalRole;
use sofia_app_server_protocol::PluginShareTargetRole;
use sofia_config::types::McpServerConfig;
use sofia_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use sofia_core_plugins::PluginListBackgroundTaskOptions;
use sofia_core_plugins::PluginMarketplaceContext;
use sofia_core_plugins::RemotePluginInstallRequest;
use sofia_core_plugins::RemotePluginOperationError;
use sofia_core_plugins::RemotePluginOperationErrorKind;
use sofia_core_plugins::is_openai_curated_marketplace_name;
use sofia_core_plugins::loader::load_configured_plugin_mcp_servers;
use sofia_core_plugins::manifest::is_agent_plugin_manifest;
use sofia_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use sofia_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use sofia_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use sofia_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use sofia_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use sofia_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use sofia_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use sofia_core_plugins::remote::RemotePluginCatalogCacheMode;
use sofia_core_plugins::remote::RemotePluginScope;
use sofia_core_plugins::remote::is_valid_remote_plugin_id;
use sofia_core_plugins::remote::validate_remote_plugin_id;
use sofia_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use sofia_mcp::McpOAuthLoginSupport;
use sofia_mcp::McpRuntimeContext;
use sofia_mcp::oauth_login_support;
use sofia_mcp::resolve_oauth_callback;
use sofia_mcp::should_retry_without_scopes;
use sofia_plugin::PluginId;
use sofia_plugin::PluginTelemetryMetadata;
use sofia_protocol::auth::AuthMode as DomainAuthMode;
use sofia_rmcp_client::McpOAuthClientRegistration;
use sofia_rmcp_client::OAuthDiscoveryTimeout;
use sofia_rmcp_client::StreamableHttpRedirectMode;
use sofia_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(sofia_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[sofia_skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                sofia_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    sofia_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: sofia_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> sofia_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            sofia_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            sofia_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            sofia_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> sofia_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            sofia_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            sofia_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            sofia_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> sofia_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            sofia_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            sofia_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: sofia_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        sofia_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        sofia_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        sofia_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<sofia_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| sofia_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        sofia_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        sofia_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        sofia_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: sofia_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(sofia_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn plugin_list_response(
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<sofia_app_server_protocol::MarketplaceLoadErrorInfo>,
                        Vec<sofia_core_plugins::ConfiguredMarketplace>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        .errors
                        .into_iter()
                        .map(|err| sofia_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match sofia_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match sofia_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*catalog_cache_root*/ Some(config.sofia_home.as_path()),
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<sofia_core_plugins::PluginsManager>,
        config: &Config,
    ...
    async fn load_remote_installed_plugins(
        &self,
        plugins_manager: Arc<sofia_core_plugins::PluginsManager>,
        plugins_input: &sofia_core_plugins::PluginsConfigInput,
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match sofia_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| sofia_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = sofia_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(sofia_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_skill_detail = sofia_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = sofia_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = sofia_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.sofia_home.as_path(),
            &plugin_path,
        ...
        sofia_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.sofia_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = sofia_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = sofia_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.sofia_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = sofia_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.sofia_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        sofia_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.sofia_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&CodexAuth>,
        plugin_id: &str,
        plugin_app_declarations: &[sofia_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        ...
        let plugin_apps =
            sofia_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
        ...
        let (accessible_connectors, sofia_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.sofia_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !sofia_apps_ready {
            warn!(
                plugin = plugin_id,
                "sofia_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
            return Vec::new();
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if sofia_plugin::PluginId::parse(&plugin_id).is_err()
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&CodexAuth>,
    plugin_apps: &[sofia_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        ...
        metadata_by_id.extend(
            sofia_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(sofia_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    sofia_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: sofia_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: sofia_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
