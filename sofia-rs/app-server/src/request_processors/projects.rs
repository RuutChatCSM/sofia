...
use sofia_app_server_protocol::Project;
use sofia_app_server_protocol::ProjectChangeType;
use sofia_app_server_protocol::ProjectChangedNotification;
...
use sofia_app_server_protocol::ProjectDeleteResponse;
use sofia_app_server_protocol::ProjectImportParams;
use sofia_app_server_protocol::ProjectImportResponse;
use sofia_app_server_protocol::ProjectListParams;
use sofia_app_server_protocol::ProjectListResponse;
use sofia_app_server_protocol::ProjectMoveParams;
use sofia_app_server_protocol::ProjectMoveResponse;
use sofia_app_server_protocol::ProjectReadParams;
use sofia_app_server_protocol::ProjectReadResponse;
use sofia_app_server_protocol::ProjectRoot;
use sofia_app_server_protocol::ProjectSortKey;
use sofia_app_server_protocol::ProjectUpdateParams;
use sofia_app_server_protocol::ProjectUpdateResponse;
...
use sofia_thread_store::CreateProjectParams as StoreCreateProjectParams;
use sofia_thread_store::ListProjectsParams as StoreListProjectsParams;
use sofia_thread_store::MoveProjectParams as StoreMoveProjectParams;
use sofia_thread_store::ProjectMoveOutcome;
use sofia_thread_store::ProjectSortKey as StoreProjectSortKey;
use sofia_thread_store::SortDirection as StoreSortDirection;
use sofia_thread_store::StoredProject;
use sofia_thread_store::StoredProjectRoot;
use sofia_thread_store::ThreadStore;
use sofia_thread_store::ThreadStoreError;
use sofia_thread_store::UpdateProjectParams as StoreUpdateProjectParams;
...
fn validate_roots(roots: Vec<ProjectRoot>) -> Result<Vec<StoredProjectRoot>, JSONRPCErrorError> {
    ...
    roots
        .into_iter()
        .map(|root| {
            let path = sofia_utils_absolute_path::AbsolutePathBuf::from_absolute_path_checked(
...
fn api_project(project: StoredProject) -> Result<Project, JSONRPCErrorError> {
    Ok(Project {
        ...
        roots: project
            ...
            .map(|root| {
                Ok(ProjectRoot {
                    path: sofia_utils_absolute_path::AbsolutePathBuf::from_absolute_path(root.path)
                        .map_err(|error| {
