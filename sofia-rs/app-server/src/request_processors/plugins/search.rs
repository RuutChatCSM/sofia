...
use sofia_app_server_protocol::PluginSearchResult;
use sofia_app_server_protocol::PluginSearchScope;
use sofia_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use sofia_core_plugins::remote::RemotePluginSearchRequest;
use sofia_core_plugins::remote::search_remote_plugins;
