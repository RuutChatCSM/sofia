...
use sofia_app_server_protocol::ThreadSectionCreateResponse;
use sofia_app_server_protocol::ThreadSectionDeleteParams;
use sofia_app_server_protocol::ThreadSectionDeleteResponse;
...
use sofia_app_server_protocol::ThreadSectionUpdateResponse;
use sofia_state::PINNED_THREAD_SECTION_ID;
use sofia_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use sofia_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use sofia_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use sofia_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use sofia_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> sofia_state::ThreadSectionAppearance {
    sofia_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
