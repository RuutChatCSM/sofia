...
use sofia_login::default_client::SetOriginatorError;
use sofia_login::default_client::USER_AGENT_SUFFIX;
...
use sofia_protocol::mcp::OPENAI_ELICITATION_EXTENSION_ID;

use super::*;
use crate::message_processor::ConnectionSessionState;
use crate::message_processor::InitializedConnectionSessionState;

const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["sofia_app_server_daemon", "sofia-backend"];
...
impl InitializeRequestProcessor {
    ...
    pub(crate) async fn initialize(
        ...
        let mut client_mcp_extensions = sofia_mcp::client_mcp_extensions(
            extensions,
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for SOFIA_INTERNAL_ORIGINATOR_OVERRIDE,
