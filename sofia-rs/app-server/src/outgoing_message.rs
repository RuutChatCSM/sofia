...
use sofia_app_server_protocol::Result;
...
use sofia_otel::span_w3c_trace_context;
...
pub(crate) use sofia_app_server_transport::ConnectionId;
pub(crate) use sofia_app_server_transport::OutgoingError;
pub(crate) use sofia_app_server_transport::OutgoingMessage;
pub(crate) use sofia_app_server_transport::OutgoingResponse;
pub(crate) use sofia_app_server_transport::QueuedOutgoingMessage;
...
pub(crate) struct OutgoingMessageSender {
    verification_auth: OnceLock<Arc<sofia_login::AuthManager>>,
    ...
    pub(crate) async fn send_request_to_connections(
        ...
        let user_verification = matches!(
            ...
            ServerRequest::McpServerElicitationRequest { params, .. }
                if matches!(&params.request, sofia_app_server_protocol::McpServerElicitationRequest::UserVerification { .. })
        );
...
mod tests {
    ...
    use sofia_app_server_protocol::ApplyPatchApprovalParams;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-sofia".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, sofia_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    sofia_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
