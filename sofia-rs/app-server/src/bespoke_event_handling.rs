...
use sofia_app_server_protocol::AccountRateLimitsUpdatedNotification;
use sofia_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use sofia_app_server_protocol::AuthRecoveryNotification;
use sofia_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use sofia_app_server_protocol::CommandAction as V2ParsedCommand;
use sofia_app_server_protocol::CommandExecutionApprovalDecision;
use sofia_app_server_protocol::CommandExecutionPresentation;
use sofia_app_server_protocol::CommandExecutionRequestApprovalParams;
use sofia_app_server_protocol::CommandExecutionRequestApprovalResponse;
use sofia_app_server_protocol::CommandExecutionSource;
use sofia_app_server_protocol::CommandExecutionStatus;
use sofia_app_server_protocol::DeprecationNoticeNotification;
use sofia_app_server_protocol::DynamicToolCallParams;
use sofia_app_server_protocol::EnvironmentConnectionNotification;
use sofia_app_server_protocol::ErrorNotification;
use sofia_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use sofia_app_server_protocol::FileChangeApprovalDecision;
use sofia_app_server_protocol::FileChangeRequestApprovalParams;
use sofia_app_server_protocol::FileChangeRequestApprovalResponse;
use sofia_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use sofia_app_server_protocol::GuardianWarningNotification;
use sofia_app_server_protocol::HookCompletedNotification;
use sofia_app_server_protocol::HookStartedNotification;
use sofia_app_server_protocol::ItemCompletedNotification;
use sofia_app_server_protocol::ItemStartedNotification;
use sofia_app_server_protocol::McpServerElicitationAction;
use sofia_app_server_protocol::McpServerElicitationRequestParams;
use sofia_app_server_protocol::McpServerElicitationRequestResponse;
use sofia_app_server_protocol::McpServerStartupState;
use sofia_app_server_protocol::McpServerStatusUpdatedNotification;
use sofia_app_server_protocol::ModelReroutedNotification;
use sofia_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use sofia_app_server_protocol::ModelVerificationNotification;
use sofia_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use sofia_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use sofia_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use sofia_app_server_protocol::PermissionsRequestApprovalParams;
use sofia_app_server_protocol::PermissionsRequestApprovalResponse;
use sofia_app_server_protocol::RawResponseCompletedNotification;
use sofia_app_server_protocol::RawResponseItemCompletedNotification;
use sofia_app_server_protocol::RequestId;
use sofia_app_server_protocol::ServerNotification;
use sofia_app_server_protocol::ServerRequestPayload;
use sofia_app_server_protocol::StrictReviewRequiredNotification;
use sofia_app_server_protocol::ThreadGoalUpdatedNotification;
use sofia_app_server_protocol::ThreadItem;
use sofia_app_server_protocol::ThreadRealtimeClosedNotification;
use sofia_app_server_protocol::ThreadRealtimeErrorNotification;
use sofia_app_server_protocol::ThreadRealtimeItemAddedNotification;
use sofia_app_server_protocol::ThreadRealtimeItemCompletedNotification;
use sofia_app_server_protocol::ThreadRealtimeItemStartedNotification;
use sofia_app_server_protocol::ThreadRealtimeItemTranscriptDeltaNotification;
use sofia_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use sofia_app_server_protocol::ThreadRealtimeSdpNotification;
use sofia_app_server_protocol::ThreadRealtimeStartedNotification;
use sofia_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use sofia_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use sofia_app_server_protocol::ThreadRollbackResponse;
use sofia_app_server_protocol::ThreadSettingsUpdatedNotification;
use sofia_app_server_protocol::ThreadStatus;
use sofia_app_server_protocol::ThreadTokenUsage;
use sofia_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use sofia_app_server_protocol::ToolRequestUserInputOption;
use sofia_app_server_protocol::ToolRequestUserInputParams;
use sofia_app_server_protocol::ToolRequestUserInputQuestion;
use sofia_app_server_protocol::ToolRequestUserInputResponse;
use sofia_app_server_protocol::Turn;
use sofia_app_server_protocol::TurnCompletedNotification;
use sofia_app_server_protocol::TurnDiffUpdatedNotification;
...
use sofia_app_server_protocol::TurnModerationMetadataNotification;
use sofia_app_server_protocol::TurnPlanStep;
use sofia_app_server_protocol::TurnPlanUpdatedNotification;
use sofia_app_server_protocol::TurnStartedNotification;
use sofia_app_server_protocol::TurnStatus;
use sofia_app_server_protocol::WarningNotification;
use sofia_app_server_protocol::build_item_from_guardian_event;
use sofia_app_server_protocol::guardian_auto_approval_review_notification;
use sofia_app_server_protocol::item_event_to_server_notification;
use sofia_core::CodexThread;
use sofia_core::ThreadManager;
use sofia_features::Feature;
use sofia_protocol::ThreadId;
use sofia_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use sofia_protocol::items::TurnItem as CoreTurnItem;
use sofia_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use sofia_protocol::plan_tool::UpdatePlanArgs;
use sofia_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use sofia_protocol::protocol::Event;
use sofia_protocol::protocol::EventMsg;
use sofia_protocol::protocol::ExecApprovalRequestEvent;
use sofia_protocol::protocol::Op;
use sofia_protocol::protocol::RealtimeEvent;
use sofia_protocol::protocol::ReviewDecision;
use sofia_protocol::protocol::SubAgentActivityKind;
...
use sofia_protocol::protocol::TurnDiffEvent;
use sofia_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use sofia_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use sofia_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use sofia_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use sofia_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use sofia_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                sofia_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                sofia_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                sofia_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                sofia_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == sofia_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            if assessment.status == sofia_protocol::protocol::GuardianAssessmentStatus::InProgress
                && matches!(
                    ...
                    Some(
                        sofia_protocol::approvals::GuardianReviewReason::ElevatedRisk
                            | sofia_protocol::approvals::GuardianReviewReason::StaleScore
                            | sofia_protocol::approvals::GuardianReviewReason::IncompatibleCompaction
                            | sofia_protocol::approvals::GuardianReviewReason::ScoringFailure
                            | sofia_protocol::approvals::GuardianReviewReason::AuthorizationChanged
                    )
                )
            {
                outgoing
            ...
            let completion_status = match assessment.status {
                sofia_protocol::protocol::GuardianAssessmentStatus::Denied
                | sofia_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                sofia_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                sofia_protocol::protocol::GuardianAssessmentStatus::InProgress
                | sofia_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
        ...
        EventMsg::ElicitationRequest(request) => {
            let user_verification = matches!(
                &request.request,
                sofia_protocol::approvals::ElicitationRequest::UserVerification { .. }
            );
            let permission_guard = thread_watch_manager
                .note_permission_requested(&conversation_id.to_string())
                .await;
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: sofia_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let sofia_error_info = ev.sofia_error_info.clone();
            ...
            let turn_error = TurnError {
                ...
                message: ev.message,
                sofia_error_info: ev.sofia_error_info.map(V2CodexErrorInfo::from),
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: sofia_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: sofia_protocol::mcp::RequestId,
    pending_request_id: RequestId,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: sofia_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            sofia_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use serde_json::json;
    use sofia_app_server_protocol::AutoReviewDecisionSource;
    use sofia_app_server_protocol::GuardianApprovalReviewStatus;
    use sofia_app_server_protocol::JSONRPCErrorError;
    use sofia_app_server_protocol::ServerRequest;
    use sofia_app_server_protocol::TurnPlanStepStatus;
    use sofia_login::CodexAuth;
    use sofia_protocol::AgentPath;
    use sofia_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use sofia_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use sofia_protocol::items::DynamicToolCallItem;
    use sofia_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use sofia_protocol::items::SubAgentActivityItem;
    use sofia_protocol::items::TurnItem as CoreTurnItem;
    use sofia_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use sofia_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    use sofia_protocol::models::PermissionProfile;
    use sofia_protocol::plan_tool::PlanItemArg;
    use sofia_protocol::plan_tool::StepStatus;
    use sofia_protocol::protocol::AgentMessageEvent;
    ...
    use sofia_protocol::protocol::EventMsg;
    use sofia_protocol::protocol::GuardianAssessmentEvent;
    use sofia_protocol::protocol::GuardianAssessmentStatus;
    use sofia_protocol::protocol::ItemCompletedEvent;
    use sofia_protocol::protocol::ItemStartedEvent;
    use sofia_protocol::protocol::RateLimitSnapshot;
    use sofia_protocol::protocol::RateLimitWindow;
    use sofia_protocol::protocol::SessionSource;
    ...
    use sofia_thread_store::StoredThreadHistory;
    use sofia_utils_absolute_path::AbsolutePathBuf;
    use sofia_utils_absolute_path::test_support::PathBufExt;
    use sofia_utils_absolute_path::test_support::test_path_buf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: sofia_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(sofia_protocol::protocol::GuardianRiskLevel::Low),
                Some(sofia_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(sofia_protocol::protocol::GuardianRiskLevel::High),
                Some(sofia_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(sofia_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = sofia_protocol::protocol::GuardianAssessmentAction::Command {
            source: sofia_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: sofia_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: sofia_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(sofia_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(sofia_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    sofia_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(sofia_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(sofia_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = sofia_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: sofia_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: sofia_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            sofia_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&sofia_home).await;
        let thread_manager = Arc::new(
            sofia_core::test_support::thread_manager_with_models_provider_and_home(
                CodexAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.sofia_home.to_path_buf(),
                Arc::new(sofia_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let sofia_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(sofia_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                sofia_error_info: Some(V2CodexErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(sofia_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(sofia_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(sofia_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let sofia_core::NewThread {
            ...
            .start_thread(sofia_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: sofia_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                sofia_error_info: Some(V2CodexErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("sofia"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                sofia_error_info: Some(V2CodexErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
