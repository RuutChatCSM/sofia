    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: sofia_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        sofia_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                sofia_app_server_protocol::AdditionalFileSystemPermissions {
