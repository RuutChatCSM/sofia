use sofia_app_server_protocol::AppBranding as ApiAppBranding;
use sofia_app_server_protocol::AppInfo as ApiAppInfo;
use sofia_app_server_protocol::AppMetadata as ApiAppMetadata;
use sofia_app_server_protocol::AppReview as ApiAppReview;
use sofia_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use sofia_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use sofia_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use sofia_connectors::AppBranding;
use sofia_connectors::AppInfo;
use sofia_connectors::AppMetadata;
use sofia_connectors::AppReview;
use sofia_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `sofia-connectors` into the app-server wire
/// type owned by `sofia-app-server-protocol`.
///
