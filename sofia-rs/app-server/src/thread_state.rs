...
use sofia_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: sofia_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<sofia_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) paginated_turns: Option<Vec<Turn>>,
    pub(crate) paginated_initial_turns_page: Option<sofia_app_server_protocol::TurnsPage>,
    pub(crate) paginated_initial_turns_page_with_active_slot:
        Option<sofia_app_server_protocol::TurnsPage>,
    pub(crate) resume_cursor_store: Option<Arc<dyn sofia_thread_store::ThreadStore>>,
