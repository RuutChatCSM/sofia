...
use sofia_external_agent_migration::ExternalAgentConfigImportItemResult;
use sofia_external_agent_migration::record_import_error;
use sofia_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use sofia_external_agent_migration::sessions::ExistingSessionAppend;
use sofia_external_agent_migration::sessions::ExternalAgentSessionMigration;
use sofia_external_agent_migration::sessions::ImportedExternalAgentSession;
use sofia_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use sofia_external_agent_migration::sessions::PendingSessionImport;
use sofia_external_agent_migration::sessions::SessionImportTarget;
use sofia_external_agent_migration::sessions::SessionMetadataMode;
use sofia_external_agent_migration::sessions::append_existing_session;
use sofia_external_agent_migration::sessions::append_imported_session_connector_names;
use sofia_external_agent_migration::sessions::detect_imported_cla_session_connectors_by_source_path;
use sofia_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use sofia_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    pub(super) async fn import_sessions(
        ...
        let completed_imports = completed_imports
            ...
            .collect();
        if let Err(err) = record_completed_session_imports(&self.sofia_home, completed_imports) {
            record_import_error(
                &mut item_result,
                "session_ledger_update",
    ...
    async fn prepare_session_import(
        ...
        tokio::task::spawn_blocking(move || {
            prepare_validated_session_import_with_metadata_mode(&sofia_home, session, metadata_mode)
        })
        .await
        .map_err(|err| {
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: sofia_login::default_client::originator().value,
