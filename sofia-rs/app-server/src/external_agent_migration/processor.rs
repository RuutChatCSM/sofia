...
use sofia_analytics::ExternalAgentConfigImportCompletedInput;
use sofia_analytics::ExternalAgentConfigImportFailureInput;
...
use sofia_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use sofia_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use sofia_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use sofia_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use sofia_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use sofia_external_agent_migration::DetectedConnectorCandidate;
use sofia_external_agent_migration::ExternalAgentConfigDetectOptions;
use sofia_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use sofia_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use sofia_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use sofia_external_agent_migration::ExternalAgentConfigService;
use sofia_external_agent_migration::ExternalAgentSessionImportLimits;
use sofia_external_agent_migration::PluginImportOutcome;
use sofia_external_agent_migration::record_import_error;
use sofia_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use sofia_external_agent_migration::sessions::read_imported_connector_candidates;
use sofia_external_agent_migration::sessions::record_detected_session_connectors;
use sofia_features::Feature;
use sofia_rollout::StateDbHandle;
use sofia_state::ExternalAgentConfigImportFailureRecord;
use sofia_state::ExternalAgentConfigImportSuccessRecord;
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.sofia_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.sofia_home())
            .map_err(|err| {
                internal_error(format!(
