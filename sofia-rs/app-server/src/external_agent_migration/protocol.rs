...
use sofia_app_server_protocol::CommandMigration;
...
use sofia_app_server_protocol::ExternalAgentConfigImportHistory;
...
use sofia_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use sofia_app_server_protocol::ExternalAgentDetectedConnectorSource;
use sofia_app_server_protocol::HookMigration;
use sofia_app_server_protocol::JSONRPCErrorError;
use sofia_app_server_protocol::McpServerMigration;
use sofia_app_server_protocol::MigrationDetails;
use sofia_app_server_protocol::PluginsMigration;
use sofia_app_server_protocol::SkillMigration;
use sofia_app_server_protocol::SubagentMigration;
use sofia_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use sofia_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use sofia_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use sofia_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use sofia_external_agent_migration::ExternalAgentConfigImportSuccess;
use sofia_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use sofia_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use sofia_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use sofia_external_agent_migration::NamedMigration;
use sofia_external_agent_migration::PluginsMigration as CorePluginsMigration;
use sofia_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| sofia_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: sofia_state::ExternalAgentConfigImportHistoryRecord,
