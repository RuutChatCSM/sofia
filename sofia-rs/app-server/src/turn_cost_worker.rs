use sofia_backend_client::ApiKeyTurnCost;
use sofia_backend_client::ApiKeyTurnCostStatus;
use sofia_backend_client::Client as BackendClient;
use sofia_backend_client::RequestError;
        ...
        match &self.backend {
            ...
            TurnCostBackend::ModelProvider(model_provider) => {
                ...
                let auth = model_provider
                    ...
                    .await
                    .map_err(|error| RequestError::Other(error.into()))?;
                let endpoint = provider.url_for_path("analytics/sofia/turn-costs");
