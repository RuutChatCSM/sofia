...
use serde_json::json;
use sofia_app_server_protocol::FuzzyFileSearchSessionCompletedNotification;
use sofia_app_server_protocol::FuzzyFileSearchSessionUpdatedNotification;
...
async fn test_fuzzy_file_search_sorts_and_includes_indices() -> Result<()> {
    // Prepare a temporary Sofia home and a separate root with test files.
