...
use sofia_app_server_protocol::ServerDiagnosticsGauge;
use sofia_app_server_protocol::ServerDiagnosticsParams;
use sofia_app_server_protocol::ServerDiagnosticsResponse;
