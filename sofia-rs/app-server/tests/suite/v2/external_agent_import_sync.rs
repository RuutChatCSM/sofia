...
const NATIVE_USER: &str = "native Sofia message";
const NATIVE_ASSISTANT: &str = "native Sofia answer";
...
impl ImportFixture {
    async fn new() -> Result<Self> {
        ...
        let app_server = start_app_server(sofia_home.path()).await?;
        Ok(Self {
...
async fn start_app_server(sofia_home: &Path) -> Result<TestAppServer> {
    let home = sofia_home.display().to_string();
