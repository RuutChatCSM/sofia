...
use sofia_app_server_protocol::Model;
use sofia_app_server_protocol::ModelListParams;
use sofia_app_server_protocol::ModelListResponse;
use sofia_app_server_protocol::ModelServiceTier;
use sofia_app_server_protocol::ModelUpgradeInfo;
use sofia_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        sofia_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
