...
use sofia_app_server_protocol::ThreadRealtimeAudioChunk;
...
use sofia_app_server_protocol::ThreadRealtimeInitialItem;
use sofia_app_server_protocol::ThreadRealtimeItem;
...
impl RealtimeE2eHarness {
    ...
    async fn start_webrtc_realtime(&mut self, offer_sdp: &str) -> Result<StartedWebrtcRealtime> {
        self.start_webrtc_realtime_with_codex_response_routing(
            ...
            /*sofia_responses_as_items*/ None,
            /*sofia_response_handoff_mode*/ None,
    ...
    async fn start_webrtc_realtime_with_codex_response_items(
        ...
        self.start_webrtc_realtime_with_codex_response_routing(
            offer_sdp,
            /*client_managed_handoffs*/ None,
            /*sofia_responses_as_items*/ Some(true),
            /*sofia_response_handoff_mode*/ None,
            /*delegation_ack_filler*/ None,
            RealtimeConversationVersion::V1,
        )
    ...
    async fn start_webrtc_realtime_with_codex_response_routing(
        ...
        sofia_responses_as_items: Option<bool>,
        sofia_response_handoff_mode: Option<CodexResponseHandoffMode>,
        ...
        let start_request_id = self
            ...
            .send_thread_realtime_start_request(ThreadRealtimeStartParams {
                ...
                sofia_response_item_prefix: sofia_responses_as_items
                    .unwrap_or(false)
...
async fn webrtc_v1_client_managed_handoffs_disable_automatic_output() -> Result<()> {
    ...
    assert!(
        ...
        "automatic Sofia output should not reach realtime in client-managed handoff mode"
    );
...
async fn webrtc_v1_ignores_codex_response_handoff_mode() -> Result<()> {
    ...
    let started = harness
        .start_webrtc_realtime_with_codex_response_routing(
            ...
            /*client_managed_handoffs*/ None,
            /*sofia_responses_as_items*/ None,
            /*sofia_response_handoff_mode*/ Some(CodexResponseHandoffMode::BemTags),
            /*delegation_ack_filler*/ None,
            RealtimeConversationVersion::V1,
        )
        .await?;
...
async fn websocket_v2_background_agent_steering_ack_requests_response_create() -> Result<()> {
    ...
    // Phase 4: release the gated delegated turn. Sofia should then continue
