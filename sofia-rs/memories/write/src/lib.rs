//! Write-path implementation for Sofia memories.
//!
...
mod guard_limits {
    pub(super) const SOFIA_LIMIT_ID: &str = "sofia";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: sofia_protocol::openai_models::ReasoningEffort =
        sofia_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    pub(super) const REASONING_EFFORT: sofia_protocol::openai_models::ReasoningEffort =
        sofia_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
...
pub fn memory_root(sofia_home: &AbsolutePathBuf) -> AbsolutePathBuf {
    sofia_home.join("memories")
}
