...
//! `EscalateRequest` over the inherited `SOFIA_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `SOFIA_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use sofia_protocol::approvals::EscalationPermissions;
pub use sofia_protocol::approvals::ResolvedPermissionProfile;
