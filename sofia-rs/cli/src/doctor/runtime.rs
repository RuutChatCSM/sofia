//! Captures how this Sofia process was launched.
//!
...
/// Builds the process provenance row for the current Sofia executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Sofia package.");
    }
    check
}
