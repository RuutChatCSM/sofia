//! Diagnoses whether Sofia update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str = "https://release.ruut.chat/sofia/channels/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/sofia.json";
#[cfg(all(target_os = "macos", target_arch = "x86_64"))]
const DESKTOP_UPDATE_URL: &str = "https://persistent.oaistatic.com/sofia-app-prod/appcast-x64.xml";
#[cfg(all(target_os = "macos", not(target_arch = "x86_64")))]
const DESKTOP_UPDATE_URL: &str = "https://persistent.oaistatic.com/sofia-app-prod/appcast.xml";
#[cfg(target_os = "macos")]
const BACKEND_DESKTOP_UPDATE_URL: &str = "https://chatgpt.com/backend-api/wham/app/appcast";
#[cfg(target_os = "windows")]
const DESKTOP_UPDATE_URL: &str =
    "https://persistent.oaistatic.com/sofia-app-prod/windows-store-update.json";
...
pub(super) async fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.sofia_home.join(VERSION_FILE_NAME);
...
fn windows_store_update(
    ...
    if manifest.schema_version == 0
        ...
        || manifest.package_identity != "OpenAI.Sofia"
    {
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @ruut/sofia",
        InstallMethod::Bun => "bun install -g @ruut/sofia",
        InstallMethod::VitePlus => "vp install -g @ruut/sofia",
        InstallMethod::Pnpm => "pnpm add -g @ruut/sofia",
        InstallMethod::Brew => "brew upgrade --cask sofia",
    ...
    tokio::time::timeout(Duration::from_secs(/*secs*/ 5), async {
        let mut response = client
            ...
            .header(
                ...
                concat!("sofia-doctor/", env!("CARGO_PKG_VERSION")),
            )
            .send()
            .await
...
mod tests {
    ...
    fn macos_update_probe_uses_the_persisted_production_appcast_feed() {
        ...
        let state_directory = home
            .path()
            .join("Library/Application Support/com.openai.sofia");
    ...
    async fn macos_staged_updates_require_a_newer_matching_extracted_bundle() {
        ...
        for (name, identity, build) in [
            ("newest", "com.openai.sofia", "6268"),
            ("newer", "com.openai.sofia", "6168"),
            ("older", "com.openai.sofia", "6138"),
            ("different", "com.example.other", "9999"),
            ("invalid", "com.openai.sofia", "invalid"),
        ] {
        ...
        write_macos_bundle(&linked, "com.openai.sofia", "9999");
