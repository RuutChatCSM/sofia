...
pub use sofia_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\sofia.zip").as_deref(),
            Some("/mnt/c/Temp/sofia.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/sofia.tgz").as_deref(),
            Some("/mnt/d/Work/sofia.tgz")
        );
        assert!(win_path_to_wsl("/home/user/sofia").is_none());
    }
