...
use sofia_code_mode_protocol::CodeModeSession;
use sofia_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use sofia_code_mode_protocol::CodeModeSessionDelegate;
use sofia_code_mode_protocol::CodeModeSessionResultFuture;
use sofia_code_mode_protocol::CodeModeToolKind;
use sofia_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use sofia_code_mode_protocol::ExecuteRequest;
use sofia_code_mode_protocol::ExecuteToPendingOutcome;
use sofia_code_mode_protocol::FunctionCallOutputContentItem;
use sofia_code_mode_protocol::ImageDetail;
use sofia_code_mode_protocol::NoopCodeModeSessionDelegate;
use sofia_code_mode_protocol::RuntimeResponse;
use sofia_code_mode_protocol::StartedCell;
use sofia_code_mode_protocol::WaitOutcome;
use sofia_code_mode_protocol::WaitRequest;
use sofia_code_mode_protocol::WaitToPendingOutcome;
use sofia_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: sofia_protocol::ToolName {
