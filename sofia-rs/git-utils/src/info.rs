...
/// directory. If you need Sofia to work from such a checkout simply pass the
...
mod tests {
    ...
    async fn git_metadata_commands_do_not_inherit_stdin() {
        const CHILD_ENV: &str = "SOFIA_GIT_UTILS_STDIN_CHILD";
