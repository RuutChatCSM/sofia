...
pub use sofia_file_system::WalkOptions;
pub use sofia_file_system::WalkOutcome;
...
use sofia_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        ...
        Self {
            shell: sofia_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `sofia-linux-sandbox` are command
...
mod tests {
    ...
    use sofia_network_proxy::RemoteNetworkProxyLaunchConfig;
    use sofia_protocol::config_types::WindowsSandboxProxySettingsMode;
    ...
    fn exec_params_keeps_proxy_launch_separate_from_sandbox_facts() {
        ...
        let params = ExecParams {
            ...
            metadata: Some(ExecMetadata {
                thread_id: Some(sofia_protocol::ThreadId::new()),
