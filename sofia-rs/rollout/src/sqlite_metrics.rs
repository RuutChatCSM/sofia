...
use sofia_otel::ORIGINATOR_TAG;
use sofia_otel::bounded_originator_tag_value;
use sofia_state::DbTelemetry;
use sofia_state::DbTelemetryHandle;
use sofia_state::LOG_WRITE_BYTES_METRIC;
use sofia_state::LOG_WRITE_MAX_ENTRY_BYTES_METRIC;
...
pub(crate) fn recorder(metrics: sofia_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
