...
use sofia_app_server_protocol::RemoteControlDisableParams;
use sofia_app_server_protocol::RemoteControlDisableResponse;
use sofia_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<sofia_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_CODEX_HOME: &str = "/tmp/sofia-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "sofia_app_server/1.2.3",
