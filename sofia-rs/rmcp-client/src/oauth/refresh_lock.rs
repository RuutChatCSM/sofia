...
const LOCK_CONTENTION_EVENT_TARGET: &str = "sofia_rmcp_client::oauth::refresh_lock::contention";
...
impl RefreshCredentialLock {
    pub(crate) async fn acquire_for_server(server_name: &str, url: &str) -> Result<Self> {
        ...
        Self::acquire_in(&sofia_home, &store_key, REFRESH_LOCK_ACQUIRE_TIMEOUT)
            .await
    ...
    async fn acquire_in(
        ...
        // Scope coordination to SOFIA_HOME alongside File and Secrets state. Direct keyring
