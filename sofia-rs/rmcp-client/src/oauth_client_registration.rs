...
pub enum McpOAuthClientRegistration {
    ...
    #[default]
    Auto,
    /// Require a ChatGPT-hosted Sofia public native Client ID Metadata Document.
    Cimd,
...
pub(crate) async fn start_authorization(
    ...
    if offer_cimd {
        ...
        let client_metadata_url = if uses_shared_callback {
            "https://chatgpt.com/oauth/sofia/client.json".to_string()
        } else {
            format!("https://chatgpt.com/oauth/sofia/{callback_id}/client.json")
        };
