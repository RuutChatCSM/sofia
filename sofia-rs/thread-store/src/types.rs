...
use sofia_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by Sofia before opening persistence.
...
pub struct StoredTurnError {
    ...
    pub message: String,
    /// Structured Sofia error classification, when available.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(sofia_protocol::protocol::SessionMetaLine {
