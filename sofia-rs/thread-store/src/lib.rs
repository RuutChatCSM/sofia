...
//!
//! Application code should treat [`sofia_protocol::ThreadId`] as the only durable thread handle.
...
pub use sofia_state::MAX_QUEUE_ITEMS;
pub use sofia_state::ProjectSortKey;
pub use sofia_state::QueuedUserSubmissionRecord;
