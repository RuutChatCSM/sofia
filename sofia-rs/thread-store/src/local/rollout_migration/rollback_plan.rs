...
use sofia_rollout::RetainedContextEntry;
use sofia_rollout::RetainedInputSource;
...
impl RollbackPlanner {
    ...
    pub(super) fn observe(&mut self, line: &RolloutLine) -> ThreadStoreResult<()> {
        ...
        match &line.item {
            ...
            RolloutItem::RetainedContext(sofia_rollout::RetainedContextEvent::VerifiedAnswer {
                answer,
                acceptance_order,
            }) => {
