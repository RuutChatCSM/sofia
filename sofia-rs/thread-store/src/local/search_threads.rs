...
use sofia_rollout::first_rollout_content_match_snippet;
use sofia_rollout::parse_cursor;
use sofia_rollout::search_rollout_matches;
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = sofia_rollout::plain_rollout_path(item.path.as_path());
