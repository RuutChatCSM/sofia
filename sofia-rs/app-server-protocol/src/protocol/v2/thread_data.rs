...
use sofia_protocol::protocol::MisalignmentErrorDetails as CoreMisalignmentErrorDetails;
use sofia_protocol::protocol::MisalignmentSteer as CoreMisalignmentSteer;
use sofia_protocol::protocol::SessionSource as CoreSessionSource;
use sofia_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use sofia_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Sofia-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, sofia exec, sofia app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Sofia-generated turn IDs are UUIDv7.
    pub id: String,
