...
use sofia_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use sofia_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use sofia_protocol::turn_input::CyberAccessProgram as CoreCyberAccessProgram;
use sofia_protocol::user_input::ByteRange as CoreByteRange;
use sofia_protocol::user_input::TextElement as CoreTextElement;
...
/// Requested cyber treatment for a ChatGPT-authenticated Sofia turn.
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Sofia's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-sofia-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
