...
use sofia_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use sofia_protocol::openai_models::ReasoningEffort;
use sofia_protocol::openai_models::default_input_modalities;
use sofia_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use sofia_protocol::protocol::ModelVerification as CoreModelVerification;
use sofia_protocol::protocol::MultiAgentVersion as CoreMultiAgentVersion;
