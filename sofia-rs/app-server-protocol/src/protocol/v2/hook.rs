...
use serde::Serialize;
use sofia_protocol::protocol::HookEventName as CoreHookEventName;
use sofia_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use sofia_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use sofia_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use sofia_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use sofia_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use sofia_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use sofia_protocol::protocol::HookScope as CoreHookScope;
use sofia_protocol::protocol::HookSource as CoreHookSource;
use sofia_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
