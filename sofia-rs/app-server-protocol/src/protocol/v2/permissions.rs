...
use serde::Serialize;
use sofia_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use sofia_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use sofia_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use sofia_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use sofia_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use sofia_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use sofia_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> sofia_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<sofia_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: sofia_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            sofia_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            sofia_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            sofia_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
