...
use sofia_experimental_api_macros::ExperimentalApi;
use sofia_extension_items::ExtensionItem;
pub use sofia_extension_items::image_generation::ImageGenerationFailure;
pub use sofia_extension_items::image_generation::ImageGenerationItem;
pub use sofia_extension_items::sleep::SleepItem;
pub use sofia_extension_items::web_search::WebSearchAction;
pub use sofia_extension_items::web_search::WebSearchItem;
use sofia_protocol::approvals::ExecApprovalKind as CoreExecApprovalKind;
use sofia_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use sofia_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use sofia_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use sofia_protocol::items::AgentMessageContent as CoreAgentMessageContent;
pub use sofia_protocol::items::AgentMessageDelivery;
pub use sofia_protocol::items::AsyncUserInputQuestion;
...
use sofia_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use sofia_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use sofia_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use sofia_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use sofia_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: sofia_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        sofia_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        sofia_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        sofia_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        sofia_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<sofia_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: sofia_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<sofia_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: sofia_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for sofia_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
