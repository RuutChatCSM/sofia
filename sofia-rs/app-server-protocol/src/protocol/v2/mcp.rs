...
use sofia_protocol::items::McpToolCallError as CoreMcpToolCallError;
use sofia_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use sofia_protocol::mcp::McpServerInfo;
use sofia_protocol::mcp::Resource as McpResource;
pub use sofia_protocol::mcp::ResourceContent as McpResourceContent;
use sofia_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use sofia_protocol::mcp::Tool as McpTool;
use std::collections::BTreeMap;

v2_enum_from_core!(
    pub enum McpAuthStatus from sofia_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from sofia_protocol::protocol::McpStartupFailureReason {
...
v2_enum_from_core!(
    ...
    pub enum McpServerConnectionStatus from sofia_protocol::mcp::McpServerConnectionStatus {
        NotStarted,
        Starting,
        Connected,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> sofia_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => sofia_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => sofia_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => sofia_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Sofia turn when this elicitation was observed, if app-server could correlate one.
    ///
