...
use sofia_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use sofia_protocol::protocol::TokenUsage as CoreTokenUsage;
use sofia_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "sofia_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Sofia Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR SOFIA CLOUD - DO NOT USE.
...
impl From<sofia_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: sofia_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> sofia_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => sofia_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => sofia_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `sofia_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
impl From<sofia_protocol::ResponseUsageMetadata> for ResponseUsageMetadata {
    fn from(value: sofia_protocol::ResponseUsageMetadata) -> Self {
        Self {
            amount: value.amount,
