...
use serde::Serialize;
use sofia_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use sofia_protocol::protocol::SkillInterface as CoreSkillInterface;
use sofia_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use sofia_protocol::protocol::SkillScope as CoreSkillScope;
use sofia_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Sofia app-server exposes `"AVAILABLE"` in its API; the alias keeps
