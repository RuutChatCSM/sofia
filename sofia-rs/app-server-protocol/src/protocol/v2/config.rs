...
pub enum ConfigLayerSource {
    /// Default configuration supplied with the installed Sofia package.
    ...
    /// User config layer from $SOFIA_HOME/config.toml. This layer is special
    ...
    /// Path to a .sofia/ folder within a project. There could be multiple of
