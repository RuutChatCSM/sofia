...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Sofia.
    ApiKey,
    /// ChatGPT OAuth managed by Sofia (tokens persisted and refreshed by Sofia).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Sofia auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Sofia auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Sofia.
    #[serde(rename = "bedrockApiKey")]
    #[ts(rename = "bedrockApiKey")]
    #[strum(serialize = "bedrockApiKey")]
    BedrockApiKey,
    /// Amazon Bedrock AWS access keys managed by Sofia.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Sofia services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Sofia sandbox.
...
/// Superset of [`sofia_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Sofia Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(sofia_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "sofia_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    sofia_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let sofia_managed_bedrock = v2::Account::AmazonBedrock {
        ...
        assert_eq!(
            ...
            serde_json::to_value(&sofia_managed_bedrock)?,
        );
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                sofia_response_handoff_channel_prefixes: Some(std::collections::BTreeMap::from([
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: sofia_protocol::config_types::CollaborationMode {
                        mode: sofia_protocol::config_types::ModeKind::Default,
