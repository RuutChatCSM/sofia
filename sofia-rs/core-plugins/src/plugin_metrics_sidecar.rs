...
use sofia_analytics::PluginMeasurementRow;
...
pub const PLUGIN_METRICS_OUTPUT_ENV_VAR: &str = "SOFIA_PLUGIN_METRICS_OUTPUT";
...
impl PluginMetricsSidecar {
    ...
    pub async fn create_remote(
        ...
        let directory_path = temp_dir
            .join(&format!("sofia-plugin-metrics-{execution_id}"))
            .ok()?;
