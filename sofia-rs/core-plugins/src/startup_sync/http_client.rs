...
//! preserve the legacy `sofia_login::default_client::create_client_without_request_logging()`
...
//! startup-sync request helpers remain responsible for applying the standard Sofia headers.
...
use sofia_http_client::RequestBuilder;
