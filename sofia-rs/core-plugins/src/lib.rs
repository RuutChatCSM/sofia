...
pub type LoadedPlugin = sofia_plugin::LoadedPlugin<sofia_config::McpServerConfig>;
pub type PluginLoadOutcome = sofia_plugin::PluginLoadOutcome<sofia_config::McpServerConfig>;
