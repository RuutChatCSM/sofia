...
async fn picker_worktree_fork_and_cd_run_on_the_production_stack() -> Result<()> {
    ...
    write_test_config(sofia_home.path(), &root)?;
    ...
    // The launcher gives sofia-main and Tokio workers explicit 16 MiB stacks.
    ...
    terminal.wait_for_screen("Ask Sofia to do anything")?;
