...
use sofia_realtime_webrtc::StartedRealtimeWebrtcSession;
...
pub(crate) struct ManagedWorktreeTransition {
    ...
    pub(crate) manager: sofia_worktree::WorktreeManager,
    pub(crate) checkout: sofia_worktree::ManagedWorktree,
...
pub(crate) struct ManagedWorktreeCreated {
    ...
    pub(crate) result: Result<
        (
            sofia_worktree::WorktreeManager,
            sofia_worktree::ManagedWorktree,
        ),
        String,
    >,
}
...
pub(crate) enum AppEvent {
    ...
    /// Open the current thread in Sofia Desktop.
    OpenDesktopThread {
        thread_id: ThreadId,
    },
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<sofia_app_server_protocol::HooksListResponse, String>,
    },
    ...
    RealtimeWebrtcConnected {
        thread_id: ThreadId,
        attempt_id: u64,
        result: Result<(), sofia_realtime_webrtc::ConnectionError>,
    },
    ...
    FetchExperimentalFeatures {
        ...
        response_tx: tokio::sync::oneshot::Sender<
            Result<Vec<sofia_app_server_protocol::ExperimentalFeature>, String>,
        >,
    },
