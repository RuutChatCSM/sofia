//! The main Sofia TUI chat surface.
//!
...
use crate::version::SOFIA_CLI_VERSION;
...
use sofia_app_server_protocol::CodexErrorInfo as AppServerCodexErrorInfo;
...
use sofia_app_server_protocol::CommandExecutionSource as ExecCommandSource;
use sofia_app_server_protocol::CreditsSnapshot;
...
use sofia_app_server_protocol::ModelVerification as AppServerModelVerification;
use sofia_app_server_protocol::RateLimitReachedType;
...
use sofia_app_server_protocol::SkillMetadata;
use sofia_app_server_protocol::SkillsListResponse;
use sofia_app_server_protocol::ThreadGoal as AppThreadGoal;
use sofia_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use sofia_config::ConstraintResult;
...
#[cfg(test)]
use sofia_git_utils::CommitLogEntry;
use sofia_git_utils::current_branch_name;
use sofia_git_utils::get_git_repo_root;
use sofia_git_utils::local_git_branches;
use sofia_git_utils::recent_commits;
use sofia_otel::RuntimeMetricsSummary;
...
use sofia_protocol::approvals::GuardianAssessmentDecisionSource;
use sofia_protocol::approvals::GuardianAssessmentEvent;
use sofia_protocol::approvals::GuardianAssessmentStatus;
...
use sofia_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use sofia_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
...
const MEMORIES_DOC_URL: &str = "https://developers.openai.com/sofia/memories";
...
use sofia_file_search::FileMatch;
...
use sofia_utils_approval_presets::ApprovalPreset;
use sofia_utils_approval_presets::builtin_approval_presets;
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) feedback: sofia_feedback::CodexFeedback,
...
/// and by sending requests back to sofia-core.
///
...
pub(crate) struct ChatWidget {
    ...
    sofia_rate_limit_reached_type: Option<RateLimitReachedType>,
    sofia_spend_control_reached: Option<bool>,
    ...
    pub(crate) pet_http_client: sofia_http_client::RouteAwareClientPool,
...
fn request_permissions_from_params(
    params: sofia_app_server_protocol::PermissionsRequestApprovalParams,
...
impl ChatWidget {
    ...
    pub(crate) fn open_feedback_consent(&mut self, category: crate::app_event::FeedbackCategory) {
        ...
        let include_windows_sandbox_log =
            sofia_windows_sandbox::current_log_file_path_for_codex_home(&self.config.sofia_home)
                .is_file();
    ...
    /// Forward a command directly to sofia.
        ...
        T: Into<AppCommand>,
    {
        ...
        match &self.sofia_op_target {
            CodexOpTarget::Direct(sofia_op_tx) => {
                crate::session_log::log_outbound_op(&op);
                if let Err(e) = sofia_op_tx.send(op) {
...
const PLACEHOLDER: &str = "Ask Sofia to do anything";
