...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Sofia is rebuilding normal terminal scrollback, not an
...
use sofia_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
