...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let pet_http_client = sofia_http_client::RouteAwareClientPool::new(
            config.http_client_factory(),
            sofia_http_client::ClientRouteClass::Other,
        );
        ...
        let mut widget = Self {
            ...
            sofia_rate_limit_reached_type: None,
            sofia_spend_control_reached: None,
