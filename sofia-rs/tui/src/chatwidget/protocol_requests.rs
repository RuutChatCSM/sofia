...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: sofia_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, sofia_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                sofia_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                sofia_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                sofia_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                sofia_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                sofia_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                sofia_app_server_protocol::GuardianRiskLevel::Low => {
                    sofia_protocol::approvals::GuardianRiskLevel::Low
                }
                sofia_app_server_protocol::GuardianRiskLevel::Medium => {
                    sofia_protocol::approvals::GuardianRiskLevel::Medium
                }
                sofia_app_server_protocol::GuardianRiskLevel::High => {
                    sofia_protocol::approvals::GuardianRiskLevel::High
                }
                sofia_app_server_protocol::GuardianRiskLevel::Critical => {
                    sofia_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    sofia_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        sofia_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    sofia_app_server_protocol::GuardianUserAuthorization::Low => {
                        sofia_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    sofia_app_server_protocol::GuardianUserAuthorization::Medium => {
                        sofia_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    sofia_app_server_protocol::GuardianUserAuthorization::High => {
                        sofia_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                sofia_app_server_protocol::AutoReviewDecisionSource::Agent => {
