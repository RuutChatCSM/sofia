...
async fn interrupted_turn_after_goal_budget_limited_uses_budget_message_snapshot() {
    ...
    chat.handle_server_notification(
        sofia_app_server_protocol::ServerNotification::TurnStarted(
    ...
    chat.handle_server_notification(
        sofia_app_server_protocol::ServerNotification::ThreadGoalUpdated(
            sofia_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: sofia_app_server_protocol::ThreadGoal {
                    ...
                    status: sofia_app_server_protocol::ThreadGoalStatus::BudgetLimited,
    ...
    chat.handle_server_notification(
        sofia_app_server_protocol::ServerNotification::TurnCompleted(
            sofia_app_server_protocol::TurnCompletedNotification {
                thread_id: "thread-1".to_string(),
                turn: sofia_app_server_protocol::Turn {
                    id: "turn-1".to_string(),
                    items_view: sofia_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: sofia_app_server_protocol::TurnStatus::Interrupted,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
