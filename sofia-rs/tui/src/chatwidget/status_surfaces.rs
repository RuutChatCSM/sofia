...
impl ChatWidget {
    ...
    /// Clears the terminal title Sofia most recently wrote, if any.
    ///
    ...
    pub(super) fn status_line_value(&mut self, item: StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::CodexVersion => Some(SOFIA_CLI_VERSION.to_string()),
    ...
    pub(super) fn status_surface_preview_value_for_item(
        ...
        let status_line_item = match item {
            StatusSurfacePreviewItem::AppName => return Some("sofia".to_string()),
    ...
    pub(super) fn terminal_title_value_for_item(
        ...
        match item {
            TerminalTitleItem::AppName => Some("sofia".to_string()),
