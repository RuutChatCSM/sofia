...
impl ModelCatalog {
    ...
    pub(crate) fn add_connected_provider_models(
        ...
        let config =
            crate::chatwidget::connect_provider_popup::load_providers_config_in(sofia_home);
        let cached = crate::chatwidget::connect_provider_popup::cached_catalog_models(sofia_home);
