...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Sofia",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Sofia",
            ...
            SlashCommand::Skills => "use skills to improve how Sofia performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Sofia",
            ...
            SlashCommand::Permissions => "choose what Sofia is allowed to do",
            ...
            SlashCommand::Logout => "log out of Sofia",
