...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/RuutChatCSM/sofia/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const APP_TOOLTIP: &str = "Try the **Desktop app**. Run 'sofia app' or visit https://github.com/RuutChatCSM/sofia";
const MACOS_APP_TOOLTIP: &str =
    "Run `sofia app` to open the Desktop app (it installs on macOS if needed).";
...
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Desktop app**. Run 'sofia app' or visit https://github.com/RuutChatCSM/sofia";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Sofia.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Sofia is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Sofia.
...
pub(crate) mod announcement {
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Sofia currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
    ...
    pub(crate) fn parse_announcement_tip_toml(
        ...
        for raw in announcements {
            ...
            if tip.version_matches(SOFIA_CLI_VERSION)
...
mod tests {
    ...
    fn desktop_app_tooltip_uses_supported_platform_launcher() {
        ...
        if linux_app_tooltip(LinuxDesktopSession::current()).is_some() {
            ...
            insta::assert_snapshot!(tooltip, @"Run `sofia app` to open the Desktop app (it installs on macOS if needed).");
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Sofia TUI.
...
[[announcements]]
content = "Welcome to Sofia! Check out the new onboarding flow."
