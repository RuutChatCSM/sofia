...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: sofia_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<sofia_protocol::openai_models::ReasoningEffort>,
