...
impl PendingAppServerRequests {
    fn canonical_thread_id(thread_id: &str) -> String {
        sofia_protocol::ThreadId::from_string(thread_id)
...
mod tests {
    ...
    use sofia_app_server_protocol::McpElicitationObjectType;
    use sofia_app_server_protocol::McpElicitationSchema;
    ...
    use sofia_app_server_protocol::PermissionGrantScope;
    use sofia_app_server_protocol::PermissionsRequestApprovalParams;
    use sofia_app_server_protocol::PermissionsRequestApprovalResponse;
    use sofia_app_server_protocol::RequestId as AppServerRequestId;
    use sofia_app_server_protocol::ServerRequest;
    use sofia_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn colliding_approvals_resolve_only_on_their_own_thread() {
        let approvals = [
            ...
            (
                ...
                Op::RequestPermissionsResponse {
                    id: "shared-id".to_string(),
                    response: sofia_protocol::request_permissions::RequestPermissionsResponse {
                        permissions: RequestPermissionProfile::default(),
                        scope: sofia_protocol::request_permissions::PermissionGrantScope::Turn,
        ...
        for (method, op) in approvals {
            let mut pending = PendingAppServerRequests::default();
            let thread_ids = [
                sofia_protocol::ThreadId::new().to_string(),
                sofia_protocol::ThreadId::new().to_string(),
            ];
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = sofia_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
            ...
            .take_resolution(
                ...
                &Op::RequestPermissionsResponse {
                    ...
                    response: sofia_protocol::request_permissions::RequestPermissionsResponse {
                        ...
                        scope: sofia_protocol::request_permissions::PermissionGrantScope::Session,
                        strict_auto_review: false,
                    },
                },
            )
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: sofia_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            sofia_app_server_protocol::FileSystemSandboxEntry {
                                path: sofia_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: sofia_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            sofia_app_server_protocol::FileSystemSandboxEntry {
                                path: sofia_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: sofia_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: sofia_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: sofia_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
    ...
    fn resolve_notification_returns_resolved_exec_request() {
        let mut pending = PendingAppServerRequests::default();
        let thread_id = sofia_protocol::ThreadId::new().to_string();
        assert_eq!(
