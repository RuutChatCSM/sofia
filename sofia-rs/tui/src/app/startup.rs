...
impl App {
    ...
    pub async fn run(
        ...
        model_catalog.add_connected_provider_models(&config.model_provider_id, &config.sofia_home);
        ...
        let session_telemetry = SessionTelemetry::new(
            ...
            auth_mode,
            sofia_login::default_client::originator().value,
        ...
        {
            session_telemetry.counter("sofia.status_line", /*inc*/ 1, &[]);
        }
...
See the Sofia keymap documentation for supported actions and examples."
                )
            })?;
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            if should_check {
                ...
                let logs_base_dir = app.config.sofia_home.clone();
