...
use sofia_app_server_protocol::MisalignmentErrorDetails;
use sofia_app_server_protocol::MisalignmentSteer;

fn policy_error() -> AppServerTurnError {
    AppServerTurnError {
        message: "Chat paused".into(),
        sofia_error_info: Some(AppServerCodexErrorInfo::MisalignmentPolicyViolation),
...
fn error_notification(
    ...
    ServerNotification::Error(sofia_app_server_protocol::ErrorNotification {
    ...
    for reject in [false, true] {
        ...
        app.enqueue_thread_notification(
            ...
            error_notification(
                ...
                "settings-update",
                AppServerTurnError {
                    sofia_error_info: Some(AppServerCodexErrorInfo::BadRequest),
                    ..policy_error()
                },
            ),
        )
        ...
        let mut params: sofia_app_server_protocol::TurnStartParams =
        ...
        assert_eq!(
            params,
            sofia_app_server_protocol::TurnStartParams {
                thread_id: thread_id.to_string(),
                ...
                sandbox_policy: Some(sofia_app_server_protocol::SandboxPolicy::ReadOnly {
