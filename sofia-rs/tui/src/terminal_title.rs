...
//! "leave the old title alone" or "clear the title Sofia last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Sofia manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Sofia started managing the title.
