...
pub(crate) use sofia_utils_absolute_path::test_support::PathBufExt;
pub(crate) use sofia_utils_absolute_path::test_support::test_path_buf;
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(sofia_app_server_protocol::SessionSource::Cli)
}
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(sofia_app_server_protocol::SkillScope::User)
}
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(sofia_app_server_protocol::SkillScope::Repo)
}
