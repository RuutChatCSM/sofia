...
use sofia_app_server_protocol::McpElicitationEnumSchema;
use sofia_app_server_protocol::McpElicitationPrimitiveSchema;
use sofia_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use sofia_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use sofia_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use sofia_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use sofia_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use sofia_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use sofia_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use sofia_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use sofia_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use sofia_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
...
mod tests {
    ...
    fn switching_fields_clears_length_validation_flash() {
        ...
        overlay.handle_paste("x".repeat(sofia_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS + 1));
