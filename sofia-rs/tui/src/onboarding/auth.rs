...
use sofia_app_server_protocol::AuthMode as ApiAuthMode;
...
pub(super) fn onboarding_request_id() -> sofia_app_server_protocol::RequestId {
    sofia_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<sofia_app_server_protocol::CancelLoginAccountResponse>(
...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = if self.bedrock_setup_enabled {
            vec!["  Choose how you want to use Sofia.".into(), "".into()]
        } else {
            vec![
                Line::from(vec![
                    "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        ...
        docs_line.push_span(
            "Sofia docs".underlined(),
            Some("https://developers.openai.com/sofia/security"),
        );
        ...
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Sofia".into(),
            docs_line,
            "".into(),
            "  Sofia can make mistakes".into(),
            HyperlinkLine::new(
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Sofia will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    const PRODUCTION_LENGTH_AUTH_URL: &str = concat!(
        ...
        "sofia_cli_simplified_flow=true&",
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .sofia_home(sofia_home_path.clone())
            .build()
            .await
            .unwrap();
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                sofia_app_server_client::EnvironmentManager::default_for_tests(),
            ),
    ...
    async fn bedrock_option_requires_feature_and_api_login_permission() {
        ...
        insta::assert_snapshot!(rows.join("\n"), @r###"
          Choose how you want to use Sofia.
    ...
    fn chatgpt_success_message_renders_osc8_hyperlinks() {
        ...
        assert_eq!(
            collect_osc8_chars(&buf, area, "https://developers.openai.com/sofia/security"),
            "Sofia docs"
        );
        assert_eq!(
        ...
        ✓ Signed in with your ChatGPT account
          ...
          Decide how much autonomy you want to grant Sofia
          For more details see the Sofia docs

          Sofia can make mistakes
          Review the code it writes and commands it runs
