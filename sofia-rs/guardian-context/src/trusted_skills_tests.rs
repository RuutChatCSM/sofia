...
fn renders_verified_skill_paths() {
    assert_eq!(
        rendered_paths(vec!["/home/user/.sofia/skills/demo/SKILL.md".to_owned()]),
        vec!["/home/user/.sofia/skills/demo/SKILL.md"],
    );
}
...
fn bounds_escaped_skill_paths_without_corrupting_json_or_utf8() {
    let paths = (0..16)
        .map(|index| {
            format!(
                "/home/user/.sofia/skills/{index:03}/{}SKILL.md",
                "\u{0001}é".repeat(80)
            )
        })
        .collect::<Vec<_>>();
...
fn preserves_multiple_invoked_skill_paths() {
    assert_eq!(
        rendered_paths(vec![
            "/home/user/.sofia/skills/first/SKILL.md".to_owned(),
            "/home/user/.sofia/skills/second/SKILL.md".to_owned(),
        ]),
        vec![
            "/home/user/.sofia/skills/first/SKILL.md",
            "/home/user/.sofia/skills/second/SKILL.md",
        ],
    );
}
