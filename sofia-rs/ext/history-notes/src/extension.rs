...
use sofia_analytics::ThreadHintStatus;
use sofia_analytics::ThreadHintStatusEvent;
...
/// Installs the standalone history and notes tools backed by the Sofia backend.
