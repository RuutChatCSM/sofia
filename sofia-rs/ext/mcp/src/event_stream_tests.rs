...
use sofia_mcp::McpEventNotification;
...
impl Fixture {
    pub async fn new() -> Result<Self> {
        ...
        let mut server_config = sofia_mcp::hosted_plugin_runtime_mcp_server_config(
        ...
        *bearer_token_env_var = None;
        ...
        let runtime_input = || McpRuntimeInput {
            ...
            mcp_servers: HashMap::from([(
                SOFIA_APPS_MCP_SERVER_NAME.into(),
            ...
            sofia_apps_tools_cache: Default::default(),
            tool_catalog_cache: Default::default(),
            sofia_apps_tools_cache_key: sofia_mcp::sofia_apps_tools_cache_key(Some(&auth_value)),
        ...
        assert!(
            runtime
                .latest_wait_for_server_ready(SOFIA_APPS_MCP_SERVER_NAME, WAIT)
                .await
        );
        Ok(Self {
            _home: home,
