...
use sofia_connectors_extension::ExecutorPluginConnectorProvider;
use sofia_core::config::Config;
use sofia_core_plugins::ExecutorPluginProvider;
use sofia_core_plugins::loader::apply_configured_plugin_mcp_server_policies;
use sofia_core_plugins::loader::configured_plugin_mcp_server_policies;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, sofia_config::McpServerConfig)>,
