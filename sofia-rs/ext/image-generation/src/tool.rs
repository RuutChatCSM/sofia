...
use sofia_extension_api::parse_tool_input_schema;
...
impl<'call> ToolExecutor<ToolCall<'call>> for ImageGenerationTool {
    ...
    fn handle<'a>(&'a self, call: ToolCall<'call>) -> sofia_extension_api::ToolExecutorFuture<'a>
    where
        'call: 'a,
    {
    ...
    async fn handle_call(
        ...
        .map_err(|error| {
            (
                ...
                usage_limit_failure(error.sofia_error()),
            )
        })
