...
pub(crate) const CLASSIFICATION_TRUNCATION_METRIC: &str =
    "sofia.guardian_v2.classification.truncation";
pub(crate) const CLASSIFICATION_TRUNCATION_BYTES_METRIC: &str =
    "sofia.guardian_v2.classification.truncation.bytes";

pub(crate) use sofia_guardian_context::TruncationObservation;
