...
use sofia_guardian_context::TrustedSkills;
...
pub(crate) const CLASSIFICATION_TOKEN_USAGE_METRIC: &str =
    "sofia.guardian_v2.classification.token_usage";
...
const TURN_METADATA_KEY: &str = "x-sofia-turn-metadata";
    ...
    pub async fn sample(&self, request: LunaSamplingRequest) -> Result<String, LunaSamplerError> {
        ...
        'retry: loop {
            ...
            let mut client_metadata = HashMap::from([
                ...
                ("x-sofia-window-id".to_owned(), format!("{thread_id}:0")),
