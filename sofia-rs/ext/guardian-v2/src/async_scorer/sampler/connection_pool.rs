...
use sofia_api::ResponseStream;
use sofia_api::ResponsesApiRequest;
use sofia_api::ResponsesClient;
use sofia_api::ResponsesEndpoint;
use sofia_api::ResponsesOptions;
use sofia_api::ResponsesWebsocketClient;
use sofia_api::ResponsesWebsocketConnection;
...
impl ConnectionPool {
    ...
    async fn open_connection(
        ...
        if let Some(metrics) = self.config.metrics.as_deref() {
            ...
            metrics.histogram(
                "sofia.guardian_v2.connection.duration_ms",
