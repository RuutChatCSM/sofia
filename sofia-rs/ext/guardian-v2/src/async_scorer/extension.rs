...
use sofia_analytics::GuardianV2Event;
use sofia_analytics::GuardianV2EventKind;
use sofia_core::ThreadManager;
use sofia_core::config::Config;
use sofia_core::context::GuardianContextMode;
use sofia_core::context::GuardianReviewEvidence;
...
use sofia_extension_api::GuardianV2Enabled;
...
use sofia_extension_api::ThreadOriginator;
...
use sofia_login::AgentIdentityAuthPolicy;
...
use sofia_protocol::protocol::has_full_access;
...
use sofia_core::context::GuardianReviewEvidenceFragment;
use sofia_guardian_context::PreviousReviews;
use sofia_guardian_context::ReviewEvidence;
use sofia_guardian_context::TranscriptImageInput;
use sofia_guardian_context::TranscriptImages;
use sofia_guardian_context::render_review_evidence;
...
impl GuardianV2Extension {
    ...
    async fn score_tool(&self, input: ToolStartInput<'_>) {
        ...
        let sofia_core::context::GuardianUserInputSnapshot {
        ...
        tokio::spawn(async move {
            ...
            if let Some(analytics) = analytics {
                analytics.track_guardian_v2_event(GuardianV2Event {
                    ...
                    occurred_at_ms: sofia_analytics::now_unix_millis(),
