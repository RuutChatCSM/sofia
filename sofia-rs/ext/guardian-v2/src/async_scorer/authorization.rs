...
use sofia_core::GuardianAuthorizationVersion;

#[derive(Clone, Debug, PartialEq)]
pub(super) struct ScoreAuthorization {
    pub(super) settings: sofia_protocol::protocol::ThreadSettingsSnapshot,
    pub(super) environments: Vec<sofia_protocol::protocol::TurnEnvironmentSelection>,
    pub(super) local: GuardianAuthorizationVersion,
    pub(super) root: Option<GuardianAuthorizationVersion>,
    pub(super) model: Option<std::sync::Arc<sofia_protocol::openai_models::ModelInfo>>,
}
