...
pub enum ApprovalDecision {
    ...
    Allow,
    Reviewed(sofia_protocol::protocol::ReviewDecision),
    AskUser,
}
...
pub trait SynchronousApprovalReviewer: Send + Sync {
    fn review(
        &self,
        reason: sofia_protocol::approvals::GuardianReviewReason,
    ) -> crate::ExtensionFuture<'_, sofia_protocol::protocol::ReviewDecision>;
}
...
pub struct ApprovalDecisionInput<'a> {
    ...
    pub thread_id: ThreadId,
    pub thread_store: &'a ExtensionData,
    pub category: sofia_protocol::openai_models::GuardianScope,
    pub approval_policy: sofia_protocol::protocol::AskForApproval,
    pub approvals_reviewer: sofia_protocol::config_types::ApprovalsReviewer,
