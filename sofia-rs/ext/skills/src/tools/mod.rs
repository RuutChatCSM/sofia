...
use sofia_analytics::SkillInvocation;
use sofia_analytics::SkillInvocationLocation;
...
impl SkillToolAuthority {
    ...
    pub(crate) fn from_authority(authority: &SkillAuthority) -> Option<Self> {
        match &authority.kind {
            SkillSourceKind::Orchestrator if authority.id == SOFIA_APPS_MCP_SERVER_NAME => {
