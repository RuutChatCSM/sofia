//! Trace bundle format, writer, and reducer for Sofia rollouts.
//!
//! This crate owns the trace schema. Hot-path Sofia code should depend on the
...
/// Shared recorder context for inference attempts within one Sofia turn.
...
pub use thread::SOFIA_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Sofia tool boundary.
...
/// Append-only writer used by hot-path Sofia instrumentation.
