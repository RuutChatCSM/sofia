...
/// One Sofia thread/session participating in the rollout.
///
...
/// Provenance for a traced Sofia thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Sofia runtime for one thread.
///
/// A Sofia turn groups protocol/runtime work for one thread activation.
