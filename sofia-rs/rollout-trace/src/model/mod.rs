...
/// Sofia conversation/session UUID.
...
/// Process/session ID returned by Sofia's terminal runtime.
...
/// Canonical reduced graph for one Sofia rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Sofia rollout/session being observed. `trace_id`
    ...
    pub sofia_turns: BTreeMap<CodexTurnId, CodexTurn>,
