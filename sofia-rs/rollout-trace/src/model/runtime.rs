...
/// Runtime operation requested by the model, a JS code cell, or Sofia itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the Sofia tool boundary.
    ///
    ...
    /// they describe how Sofia executed the request, not what the caller sent.
