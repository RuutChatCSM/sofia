...
use sofia_protocol::protocol::CollabAgentInteractionBeginEvent;
use sofia_protocol::protocol::CollabAgentInteractionEndEvent;
use sofia_protocol::protocol::CollabAgentSpawnEndEvent;
use sofia_protocol::protocol::CollabCloseBeginEvent;
use sofia_protocol::protocol::CollabCloseEndEvent;
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.sofia_turn_id.as_deref() == Some(sofia_turn_id)
