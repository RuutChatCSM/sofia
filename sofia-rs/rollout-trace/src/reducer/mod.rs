        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    sofia_turn_id: event.sofia_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(sofia_turn_id) = event.sofia_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a sofia turn id"
                    );
                };
