//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Sofia
//! crates.
...
pub use sofia_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".sofia-plugin";
