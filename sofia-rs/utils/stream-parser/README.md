# sofia-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Sofia did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Sofia on it. Feel free to update the documentation as you
modify the code
...
```rust
use sofia_utils_stream_parser::CitationStreamParser;
use sofia_utils_stream_parser::StreamTextParser;
...
```rust
use sofia_utils_stream_parser::CitationStreamParser;
use sofia_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), sofia_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use sofia_utils_stream_parser::InlineHiddenTagParser;
use sofia_utils_stream_parser::InlineTagSpec;
use sofia_utils_stream_parser::StreamTextParser;
