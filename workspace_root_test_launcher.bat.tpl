...
if defined SOFIA_BAZEL_TEST_SKIP_FILTERS (
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$skipFilters = @();" ^
  "if (-not [string]::IsNullOrEmpty($env:SOFIA_BAZEL_TEST_SKIP_FILTERS)) { $skipFilters = @($env:SOFIA_BAZEL_TEST_SKIP_FILTERS -split ',' | Where-Object { $_ -ne '' }) };" ^
