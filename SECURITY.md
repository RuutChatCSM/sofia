...
Thank you for helping us keep Sofia secure!
...
## How to operate SOFIA safely

For details on Sofia security boundaries, including sandboxing, approvals, and network controls, see [Agent approvals & security](https://developers.openai.com/sofia/agent-approvals-security).
