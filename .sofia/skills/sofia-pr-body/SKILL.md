...
If there is documentation that should be updated on https://developers.openai.com/sofia as a result of this change, please note that in a separate section near the end of the pull request. Omit this section if there is no documentation that needs to be updated.
