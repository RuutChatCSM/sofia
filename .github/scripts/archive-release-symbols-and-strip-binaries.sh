...
symbols_root="${RUNNER_TEMP:-/tmp}/sofia-symbols-${artifact_name}"
symbols_dir="${symbols_root}/sofia-symbols-${artifact_name}"
archive_path="${archive_dir%/}/sofia-symbols-${artifact_name}.tar.gz"
rm -rf "$symbols_root"
...
rm -f "$archive_path"
tar -C "$symbols_root" -czf "$archive_path" "sofia-symbols-${artifact_name}"
