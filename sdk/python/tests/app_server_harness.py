...
class AppServerHarness:
    ...
    def __init__(self, tmp_path: Path, *, requires_openai_auth: bool = False) -> None:
        ...
        self.sofia_home = tmp_path / "sofia-home"
    ...
    def __exit__(self, _exc_type: object, _exc: object, _tb: object) -> None:
        ...
        shutil.rmtree(self.sofia_home, ignore_errors=True)
    ...
    def app_server_config(self) -> CodexConfig:
        ...
        return CodexConfig(
            ...
            env={
                "SOFIA_HOME": str(self.sofia_home),
                "SOFIA_APP_SERVER_DISABLE_MANAGED_CONFIG": "1",
                "RUST_LOG": "warn",
            },
        )
    ...
    def _write_config(self) -> None:
        ...
        config_toml = self.sofia_home / "config.toml"
