...
class _AsyncLoginOwner(Protocol):
    ...
    async def _ensure_initialized(self) -> None:
        """Ensure the owning SDK client has a live Sofia connection."""
        ...
...
class ChatgptLoginHandle:
    """Live browser-login attempt returned by `Sofia.login_chatgpt()`."""
...
class DeviceCodeLoginHandle:
    """Live device-code login attempt returned by `Sofia.login_chatgpt_device_code()`."""
