...
#   filename:  sofia_app_server_protocol.v2.schemas.json
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Sofia attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    sofia_rate_limits = "codexRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `sofia_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class CodexErrorInfo(
    ...
    root: Annotated[
        ...
        | ActiveTurnNotSteerableCodexErrorInfo,
        Field(
            description="This translation layer make sure that we expose sofia error code in camel case.\n\nWhen an upstream HTTP status is available (for example, from the Responses API or a provider), it is forwarded in `httpStatusCode` on the relevant `codexErrorInfo` variant."
        ),
    ]
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    sofia_streamlined_login: Annotated[bool | None, Field(alias="codexStreamlinedLogin")] = None
...
class WebSearchThreadItem(BaseModel):
    ...
    results: Annotated[
        list | None,
        Field(
            description="Structured search results returned out-of-band by standalone web search.\n\nThese stay as opaque JSON at the extension/app-server boundary so new result fields and result types can pass through without a Sofia release."
        ),
    ] = None
...
class TurnError(BaseModel):
    ...
    sofia_error_info: Annotated[CodexErrorInfo | None, Field(alias="codexErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `sofia`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Sofia-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Sofia-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, sofia exec, sofia app-server, etc.)."
        ),
    ]
